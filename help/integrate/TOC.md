...
+ Advertising Analytics {#advertising-analytics}
   + [Vue d’ensemble d’Advertising Analytics](c-advertising-analytics/overview.md)
   + Workflow de configuration d’Advertising Analytics {#advertising-analytics-workflow}
      + [Vue d’ensemble du workflow](c-advertising-analytics/c-adanalytics-workflow/aa-workflow.md)
