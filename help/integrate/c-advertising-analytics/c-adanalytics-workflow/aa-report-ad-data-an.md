...
> [!NOTE] Vous devez vous attendre au moins 24 heures avant que les données du moteur de recherche ne commencent à être renseignées dans vos rapports Analytics. Notez également que le reporting Analytics ne renverra pas de données pour la granularité horaire, car les données AMO ne prennent pas en charge ce type de granularité.
...
| Plateformes d’annonces publicitaires | Graphique en anneau pour le coût des 2 principales plateformes (Google, Bing). |
