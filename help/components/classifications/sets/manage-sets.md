...
| Colonne | Description |
|---|---|
| **[!UICONTROL Ensemble de classifications]** | Nom de l’ensemble de classifications. Sélectionnez le nom [modifier l’ensemble de classifications](create-set.md#edit-a-classification-set). |
...
* Sélectionnez ![AddCircle](/help/assets/icons/AddCircle.svg) **[!UICONTROL New]** pour [créer un ensemble de classifications](create-set.md#create-a-classification-set).
