...
1. Dans la boîte de dialogue **[!UICONTROL Ensemble de classifications : _nom de l’ensemble de classifications_]**, sélectionnez l’onglet **[!UICONTROL Schéma]**. Cet onglet se compose des éléments d’interface suivants :
...
1. Pour sélectionner le [codage du fichier](/help/components/classifications/sets/data-files.md#general-file-requirements) lors du téléchargement du fichier, sélectionnez une option dans le menu déroulant **[!UICONTROL Encodage du fichier]**. Les options sont les suivantes :
...
Dans la boîte de dialogue **[!UICONTROL Télécharger le modèle pour _nom du jeu de classifications_]**:
...
>abstract="Liste des comptes d’emplacement des types de compte qui prennent en charge l’import des données de classification. Sélectionnez **[!UICONTROL Nouveau compte]** pour créer un compte d’emplacement."
>additional-url="https://experienceleague.adobe.com/fr/docs/analytics/components/locations/configure-import-accounts" text="Configurer des comptes d’export et d’import cloud"
...
Dans la boîte de dialogue **[!UICONTROL Associer / Mettre à jour l’emplacement d’ingestion pour _nom du jeu de classifications_]**:
...
1. Sélectionnez **[!UICONTROL Valider]**. La connexion à l’emplacement cloud est validée. Si la validation est réussie, un message toast s’affiche, affichant ![CheckmarkCircle](/help/assets/icons/CheckmarkCircle.svg) **[!UICONTROL Validation de l’emplacement réussie. La connexion à l’espace de stockage dans le cloud est vérifiée.]**<br/>Sélectionnez**[!UICONTROL  Enregistrer ]**si vous avez créé la connexion à la connexion cloud. Sinon, sélectionnez**[!UICONTROL  Mettre à jour ]**. Ou sélectionnez**[!UICONTROL  Annuler ]**pour annuler la configuration de l’emplacement du cloud.
...
La barre d’actions affiche les actions disponibles pour la classification sélectionnée. Les options disponibles sont les suivantes :
