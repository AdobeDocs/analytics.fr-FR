...
Avant de charger des données via FTP, vous devez créer un compte FTP. Pour plus d’informations, voir [Créer un compte FTP](/help/components/classifications/c-classifications-importer/c-uploading-saint-data-files-via-ftp.md#task_C019268E6C934C7C95F4326F42A22CCF).
...
Pour plus d’informations sur la création d’un compte FTP, consultez [Créer un compte FTP](/help/components/classifications/c-classifications-importer/c-uploading-saint-data-files-via-ftp.md#task_C019268E6C934C7C95F4326F42A22CCF).
...
Voir [FTP et SFTP](https://docs.adobe.com/content/help/fr-FR/analytics/export/ftp-and-sftp/ftp-overview.translate.html) pour en savoir plus sur les serveurs FTP d’Adobe.
