...
La dimension [Année](overview.md) indique l’année au cours de laquelle une mesure donnée a été effectuée. Le premier élément de dimension correspond à la première année de la période et le dernier élément de dimension correspond à l’année la plus récente de la période.
...
Les éléments de dimension comprennent une année donnée, les dates étant incluses entre parenthèses.
