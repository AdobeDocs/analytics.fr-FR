...
Les valeurs de dimension incluent les régions et le pays dans lequel la région réside. Les exemples de valeurs incluent `"California (United States)"`, `"Tokyo (Japan)"`ou `"Sao Paulo (Brazil)"`.
