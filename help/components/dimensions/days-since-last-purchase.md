...
description: Le nombre de jours entre le hit actif et le dernier achat.
feature: Dimensions
...
Les visiteurs qui n’ont jamais effectué d’achat ne sont pas inclus dans cette dimension. De plus, les hits déclenchés avant le premier achat d’un visiteur ne sont pas inclus non plus. Seuls les hits après le premier achat d’un visiteur sont inclus.
...
Les éléments de dimension comprennent le nombre de jours entre le dernier achat d’un visiteur et le hit actif. Chaque nombre de jours est un élément de dimension distinct. « Même jour » survient lorsque le dernier achat d’un visiteur et le hit actif ont lieu le même jour.
