...
Votre entreprise détermine la logique d’implémentation de ces variables de données contextuelles. Définissez chaque variable de données contextuelles sur chaque page.
