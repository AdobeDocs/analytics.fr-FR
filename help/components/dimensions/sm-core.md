...
Pour utiliser ces dimensions, activez **[!UICONTROL Media Core]** sous [[!UICONTROL Rapports multimédia]](/help/admin/tools/manage-rs/edit-settings/media-management.md) pour la suite de rapports.
