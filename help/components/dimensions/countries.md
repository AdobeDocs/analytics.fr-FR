---
title: Pays
description: Le pays d’où provient le hit.
feature: Dimensions
...
Adobe dérive cette dimension côté serveur de l’adresse IP du visiteur, en la comparant à une table de recherche interne. Adobe travaille en partenariat avec [Digital Element](https://www.digitalelement.com/) pour gérer les recherches entre l’adresse IP et le pays. Aucune variable à définir.
