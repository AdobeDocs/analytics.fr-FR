...
La [dimension](overview.md) « Mois de l’année » indique le mois d’une année donnée en tant qu’élément de dimension. Ce rapport est utile si vous souhaitez un rapport divisé par mois de l’année, mais ne souhaitez pas une date statique comme élément de dimension. Vous pouvez agréger les rapports d’une année sur l’autre par mois, de sorte que les données du mois de janvier de cette année soient agrégées avec celles du mois de janvier de l’année dernière dans le même élément de dimension.
...
Les éléments de dimension comprennent les mois de l’année (`January` à `December`), représentant le mois de l’année où le hit a eu lieu.
