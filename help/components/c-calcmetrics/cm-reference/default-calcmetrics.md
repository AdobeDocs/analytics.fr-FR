...
| Durée de la visite/de l’utilisateur (état) | Durée pendant laquelle le visiteur moyen ou la visiteuse moyenne passe dans un état particulier sur le site | `[Mobile App Users] (segment)`<br>`[Time Spent per Visitor (Seconds)] (metric)` |
