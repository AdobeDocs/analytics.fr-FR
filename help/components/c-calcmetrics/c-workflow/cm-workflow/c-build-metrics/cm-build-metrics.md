...
* Dans  Espace de travail , ouvrez un projet et cliquez sur **[!UICONTROL + New]** > **[!UICONTROL Create Metric]** .
* Dans [!DNL Analytics], accédez à **[!UICONTROL Components]** > **[!UICONTROL Calculated Metrics]**.
