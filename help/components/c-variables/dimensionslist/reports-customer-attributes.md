...
<table id="table_88631069013B408EBB0A810657662B36"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Pourquoi est-il préférable d'utiliser le service d'identité pour définir l'ID du client plutôt que de renseigner l'ID de client dans une prop ou une evar ? </p> </td> 
   <td colname="col2"> <p>L'utilisation du service d'identité offre un certain nombre d'avantages : </p> 
    <ul id="ul_5D3659604D43419F9CA5920B4F93728E"> 
     <li id="li_BA2EF0715C5A47EFAFA7191CFAD088A4">Si vous ne définissez pas l'ID de client avec le service d'identité, les dossiers du client sont disponibles uniquement pour Adobe Analytics. Si vous souhaitez utiliser les dossiers client pour le ciblage en temps réel, vous devez utiliser le service d'identité. </li> 
     ...
     <li id="li_BCF28219E4014FCF9F747C3D8D270526"> L'utilisation du service d'identité plutôt qu'une prop ou une evar libère cette prop ou evar pour d'autres utilisations. </li> 
    </ul> </td> 
  </tr> 
  <tr> 
