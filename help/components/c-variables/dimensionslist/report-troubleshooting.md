...
keywords: bonnes pratiques ; échec ; timeout ; dépannage ; lent
...
>[!Note]
>Ces recommandations s'appliquent aux rapports et analyses, à la publicité - analyses ad hoc et au créateur de rapports.
>They do not apply to Analysis Workspace, which has its own set of [best practices](/help/analyze/analysis-workspace/optimizing-performance.md). They also do not &gt;apply to Data Warehouse [best practices](https://marketing.adobe.com/resources/help/en_US/reference/?f=data_warehouse_bp). Un jeu supplémentaire de
>[les bonnes pratiques](https://marketing.adobe.com/developer/en_US/get-started/best-practices/c-best-practices) sont disponibles pour l'API de création de rapports d'Adobe Analytics.
