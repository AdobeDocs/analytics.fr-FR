---
description: Si vous êtes habitué à travailler avec le Créateur de segments dans les Ad Hoc Analysis, ce forum aux questions (FAQ) explique ce qu’il advient des segments et dossiers existants ainsi que les actions que vous devez entreprendre.
...
Si vous êtes habitué à travailler avec le Créateur de segments dans les Ad Hoc Analysis, ce forum aux questions (FAQ) explique ce qu’il advient des segments et dossiers existants ainsi que les actions que vous devez entreprendre.
