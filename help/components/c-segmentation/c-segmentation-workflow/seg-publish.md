...
Quand vous publiez un segment dans Experience Cloud, vous pouvez l’utiliser pour une activité marketing dans la [!UICONTROL bibliothèque d’audiences], dans [!DNL Target], [!DNL Audience Manager], [!DNL Advertising Cloud] et [!DNL Campaign]. Les mises à jour récentes ont considérablement optimisé le processus de publication. Auparavant, la publication d’un segment utilisable prenait environ 48 heures.
...
## Utiliser la visionneuse du profil du visiteur [!UICONTROL d’Audience Manager]
