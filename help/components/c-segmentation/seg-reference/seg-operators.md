...
Il existe trois catégories d’opérateurs : Standard, Entrepôt de données et Nombre unique.
...
| égal à n’importe lequel ; | Renvoie les éléments qui correspondent exactement à n’importe quelle valeur du champ d’entrée (jusqu’à 500 éléments). Par exemple, la saisie de "Résultats de la recherche, page d'accueil" avec cet opérateur correspondrait à "Résultats de la recherche" et "Page d'accueil", et compterait comme 2 éléments. Le champ de saisie de cet opérateur est délimité par des virgules. |
| n’est pas égal à n’importe lequel. | Identifie les éléments qui correspondent exactement à n’importe quelle valeur du champ d’entrée (jusqu’à 500 éléments), puis renvoie uniquement les éléments sans ces valeurs. Par exemple, la saisie de "Résultats de la recherche, page d'accueil" avec cet opérateur identifie "Résultats de la recherche" et "Page d'accueil", puis les exclut des éléments renvoyés. Cet exemple compte pour 2 éléments. Le champ de saisie de cet opérateur est délimité par des virgules. |
...
| **Comptage distinct** | Vous pouvez segmenter selon un nombre distinct d’éléments dans une dimension. Exemples : « Visiteurs ayant consulté plus de 5 produits distincts » ou « Visites où plus de 5 pages distinctes ont été vues ». |
