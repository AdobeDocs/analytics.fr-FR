...
1. Affichez la colonne **[!UICONTROL Publié]**. **[!UICONTROL Oui]** dans cette colonne indique que le segment a été publié sur Experience Cloud. **[!UICONTROL Non]** indique que ce n’est pas le cas.
