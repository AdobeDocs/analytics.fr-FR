...
* Assurez-vous que la suite de rapports dans laquelle vous enregistrez ce segment est [activée pour Experience Cloud](/help/components/segmentation/segmentation-workflow/seg-publish.md). Dans le cas contraire, vous ne pouvez pas le publier dans Experience Cloud.
...
* Pour plus d’informations sur les **différences entre les segments dans [!DNL Adobe Analytics] et[!DNL Audience Manager]**, voir [Présentation des segments dans Analytics et Audience Manager](/help/integrate/c-audience-analytics/aam-analytics-segments.md).
...
| Caractéristique et membres du segment | Dans les 24 à 48 heures | [!DNL Audience Manager] |
