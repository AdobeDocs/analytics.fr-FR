...
Consultez ![VideoCheckedOut](/help/assets/icons/VideoCheckedOut.svg) [Segments rapides dans Analysis Workspace](https://video.tv.adobe.com/v/345337/?captions=fre_fr&quality=12&learn=on){target="_blank"} pour une vidéo de démonstration.
...
| Élément | Description |
|---|---|
| **[!UICONTROL Dimension]**<br/>**[!UICONTROL Metric]**<br/>**[!UICONTROL Date range]** | Dans le menu déroulant ![ChevronDown](/help/assets/icons/ChevronDown.svg) choisissez si vous souhaitez spécifier une condition pour une dimension, une mesure ou une période. |
