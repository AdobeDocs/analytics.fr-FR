...
Cette vidéo présente rapidement les conteneurs de segments et leurs modes d’utilisation : [Conteneurs de segments dans Adobe Analytics](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/components/segmentation/segment-containers.html)
