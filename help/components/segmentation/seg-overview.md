...
Lors de la création de segments d’audience dans le créateur de segments, vous définissez des conditions à l’aide des opérateurs [!UICONTROL AND] et [!UICONTROL OR] entre les conteneurs.
...
- Le [Gestionnaire de segments](/help/components/segmentation/segmentation-workflow/seg-manage.md) vous permet de configurer des [workflows](/help/components/segmentation/segmentation-workflow/seg-workflow.md) avec des fonctionnalités de partage de segments, de balisage, de vérification et d’approbation.
- Vous pouvez [marquer les segments](/help/components/segmentation/segmentation-workflow/seg-tag.md) pour les organiser et les rechercher ultérieurement au lieu d’utiliser des dossiers.
...
- Utiliser les segments comme dimensions dans les visualisations de tableau à structure libre.
...
Le rail de gauche Composant affiche les segments que vous et votre société avez créés, ainsi que les segments Adobe prêts à l’emploi. Lorsque vous cliquez sur **[!UICONTROL Tout afficher]**, ces segments apparaissent généralement au bas de la liste et sont identifiés par ![AdobeLogoSmall](/help/assets/icons/AdobeLogoSmall.svg).
...
Si le segment a été [publié dans Experience Cloud](/help/components/segmentation/segmentation-workflow/seg-workflow.md), vous ne pouvez pas le supprimer ni le modifier. Cependant, vous pouvez copier le segment et modifier la version copiée.
