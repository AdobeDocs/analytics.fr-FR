---
title: Visiteurs et visiteuses uniques
...
Cette mesure comptabilise le nombre d’ID de visiteurs et visiteuses uniques pour un élément de dimension donné. Consultez [Vue d’ensemble de l’identification des visiteurs](/help/implement/id/overview.md) pour plus d’informations sur la manière dont Adobe Analytics identifie les visiteurs et visiteuses uniques.
