...
1. **[!UICONTROL Referrer]** et **[!UICONTROL Does Not Exist]** et **[!UICONTROL Is First Page of Visit]**. (Voir [Direct.](/help/components/c-marketing-channels/mc-faq/c-faq.md))

2. **[!UICONTROL Referrer Matches Internal URL Filters]** et **[!UICONTROL Is First page of Visit]**. (Voir [Interne](/help/components/c-marketing-channels/mc-faq/c-faq.md).)

3. **[!UICONTROL Referrer]** et **[!UICONTROL Exists]** et **[!UICONTROL Referrer Does Not Match Internal URL Filters]**.

Enfin, créez un canal *Other* qui capture les autres accès, comme indiqué dans la section [Aucun canal identifié](/help/components/c-marketing-channels/mc-faq/c-faq.md#no-channel-identified).
