...
>[!WARNING]
>
>Le créateur de règles de classification sera abandonné le **28 février 20276**. Passez à l’expérience [Règles des ensembles de classifications](/help/components/classifications/sets/manage/rules.md), une fois disponible, pour assurer la continuité des fonctionnalités.
>
