...
| [!UICONTROL **Fréquemment utilisée avec**] | Affiche les 5 composants les plus couramment utilisés avec le composant que vous affichez. Cette liste est basée sur les données des 90 derniers jours. Seuls les composants que vous avez accès à la vue s’affichent. |
| [!UICONTROL **Similaire à**] | Affiche 5 composants avec des libellés similaires au composant que vous affichez. Seuls les composants que vous avez accès à la vue s’affichent. |
