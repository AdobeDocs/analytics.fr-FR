...
| Alertes | Créez et gérez des alertes en fonction des anomalies de données et des alertes « empilées », qui regroupent plusieurs mesures dans une seule alerte. | [Présentation des alertes](/help/components/c-alerts/intellligent-alerts.md) |
