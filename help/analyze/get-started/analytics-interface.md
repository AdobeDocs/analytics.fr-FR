...
Utilisez la variable [!UICONTROL **Rapports**] dans le rail de gauche sur la [!UICONTROL **Workspace**] . Pour plus d’informations, consultez l’*onglet Naviguer dans les rapports* sur la [page de destination d’Adobe Analytics](/help/analyze/landing.md).
