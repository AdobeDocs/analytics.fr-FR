...
2. Sélectionnez l’une des fonctionnalités de produit suivantes pour la configurer :
   ...
   | Service d’authentification unique | L’authentification unique dans Adobe CX Enterprise est implémentée via Admin Console. | [Analytics dans l’Adobe Admin Console](/help/admin/admin-console/home.md) |
