...
Vous pouvez également définir un tableau de bord comme page de destination, partager les tableaux de bord avec d’autres utilisateurs et programmer leur remise. Si vous n’avez défini aucun tableau de bord (ni aucun signet) comme page de destination, le tableau de bord [!UICONTROL Mes rapports recommandés] s’affiche. La page **[!UICONTROL Mes rapports recommandés]** présente le rapport **[!UICONTROL Mesures clés]**, ainsi que les cinq rapports que vous consultez le plus souvent. Cet affichage est dynamique.
...
1. Configurez la mise en page du tableau de bord :
...
1. (Facultatif) Pour définir le tableau de bord comme page de destination, cliquez sur **[!UICONTROL Autres options]** > **[!UICONTROL Définir comme page de destination]**.
...
Vous pouvez ajouter du contenu d’autres tableaux de bord et des tableaux de bord partagés. Vous pouvez également ajouter le contenu de sources personnalisées et externes (texte et images, par exemple).
...
| Définir le tableau de bord comme page de destination | Dans un tableau de bord, cliquez sur [!UICONTROL Plus] > [!UICONTROL Définir comme page de destination]. |
