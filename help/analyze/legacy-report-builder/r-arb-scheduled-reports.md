...
| [!UICONTROL Options de publication] | Cette colonne répertorie les Power BI si l’une des [options de publication de Power BI](https://experienceleague.adobe.com/docs/analytics/analyze/legacy-report-builder/publish-powerbi/power-bi.html?lang=fr) est sélectionnée. |
