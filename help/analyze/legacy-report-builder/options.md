...
| Enregistrer les requêtes Report Builder dans un fichier local (pour le dépannage) | Permet d’enregistrer les requêtes dans un fichier local. Utilisez ce fichier journal à des fins de dépannage. |
