...
Dans la mise en page personnalisée, vous pouvez transformer une colonne de mesures en graphique à barres avec une valeur de pourcentage correspondante, ou une valeur de pourcentage avec un graphique à barres correspondant. La valeur de pourcentage est la valeur de la mesure ou le total de la demande globale non filtrée pour la période.
