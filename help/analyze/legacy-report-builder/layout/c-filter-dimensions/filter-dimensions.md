---
description: Vous pouvez filtrer les dimensions que vous ajoutez à la grille Libellés de ligne. Les filtres limitent les données renvoyées par les requêtes et peuvent être appliqués à partir des dispositions de tableau croisé dynamique ou personnalisées. Lorsque vous configurez le filtrage des dimensions à partir de la disposition du pivot, vous pouvez en outre spécifier le nombre d'entrées depuis la cellule.
...
Informations sur les filtres dans le panneau **[!UICONTROL Filtre les plus populaires]** > **[!UICONTROL Définir un filtre]**.
...
<table id="table_8AC3A26FF02143DBA949B30F2A46CF11"> 
 <thead> 
  <tr> 
   ...
   <th colname="col3" class="entry"> Résultats des correspondances </th> 
  </tr> 
 </thead>
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Contient tous les termes </p> </td> 
   <td colname="col02"> <p>Contient chaque valeur délimitée par des espaces dans un ordre quelconque. </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col02"> <p>Contient au moins un des filtres (délimités par des espaces). </p> </td> 
   <td colname="col2"> <p>A B C </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col02"> <p>Renvoie tout sauf si elle contient une valeur que vous avez saisie. </p> </td> 
   <td colname="col2"> <p>a b c </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col02"> <p>Renvoie tout ce qui ne contient pas votre expression. </p> </td> 
   <td colname="col2"> <p>abc </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p>Est égal </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col02"> <p>Renvoie tout ce qui ne correspond pas exactement à votre entrée. </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col02"> <p>Renvoie les résultats commençant par une valeur spécifique. </p> </td> 
   <td colname="col2"> <p>abc </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col02"> <p>Renvoie les résultats qui se terminent par la valeur spécifique. </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p> Cet exemple définit un filtre qui commence par <span class="term"> Accueil</span> puis recherche zéro ou plusieurs caractères et se termine par <span class="term"> Page</span>. </p> <p>Aussi, n’importe quelle page contenant <span class="term"> sport</span>. </p> <p>Quelques exemples de correspondance : </p> 
    <ul id="ul_72D76C5AFEAF405E8A0E4E3C604D10AE"> 
     <li id="li_4D490059B667450DA8A0103167C7B391">PageD’Accueil </li> 
     <li id="li_1351619156274092AEB2771D882AD357">Page d’accueil et (autres caractères) </li> 
     <li id="li_940EAA99A8CF49308E8471065EB317B1">Sports à domicile </li> 
     <li id="li_50A895F14A454BE9BF06EE0F07F99B3B">sportive Page </li> 
...
<table id="table_8BBB06C8860745DEA41B39673699DC0F"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Identique à l’astérisque utilisé dans une expression régulière. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> ^ </td> 
