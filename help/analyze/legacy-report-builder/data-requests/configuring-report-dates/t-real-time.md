...
1. Assurez-vous que la création de rapports en temps réel est activée dans les [outils d’administration](https://experienceleague.adobe.com/docs/analytics/admin/admin-tools/manage-report-suites/edit-report-suite/real-time-reports/t-realtime-admin.html?lang=fr).
...
1. Sélectionnez une plage de temps en minutes ou heures.
   ...
   ![Capture d&#39;écran montrant les options de sélection de la période avec sélection des 60 dernières minutes.](assets/real_time_select_date.png)
