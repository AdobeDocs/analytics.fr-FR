...
Vous pouvez modifier plusieurs requêtes en même temps, en fonction de la suite de rapports, des segments, de la granularité et de la période de la requête. Par exemple, vous pouvez mettre à jour les paramètres d’un rapport afin que toutes les requêtes soient basées sur la même suite de rapports ou le même segment, ou vous pouvez transformer un rapport quotidien en rapport hebdomadaire ou mensuel, à condition de conserver le même nombre de périodes. Vous pouvez modifier plusieurs demandes pour la feuille de calcul en cours ou toutes les feuilles d&#39;une feuille de calcul.
