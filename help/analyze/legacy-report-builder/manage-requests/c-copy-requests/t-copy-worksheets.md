...
TQID: https://experienceleague.adobe.com/gpT9WblaZGdzb-OQ9SSat2KrbiEz3PchMGb3vYH3x5c
...
1. Cliquez de nouveau avec le bouton droit et sélectionnez **[!UICONTROL Coller la feuille de calcul avec les requêtes]**.
   ...
   Une nouvelle feuille de calcul est ajoutée à votre classeur. Par défaut, la feuille de calcul porte le même nom que la feuille de calcul d&#39;origine, mais porte le suffixe (2). Si vous répétez l&#39;opération de collage, la nouvelle feuille de calcul porte le suffixe (3), etc. Lorsque vous collez une feuille de calcul que vous avez copiée, la nouvelle feuille de calcul se trouve à droite de la feuille de calcul active (immédiatement après).
