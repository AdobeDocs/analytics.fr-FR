...
* Accès direct au Générateur d’alertes :  **[!UICONTROL Components]** > **[!UICONTROL Alerts]**
...
* Dans un rapport Rapports et analyses, sélectionnez **[!UICONTROL More]** > **[!UICONTROL Add Alert]** . Le Générateur d’alertes s’ouvre, puis les mesures et filtres appropriés sont préremplis à partir du rapport. Vous pouvez modifier l’alerte si nécessaire.
