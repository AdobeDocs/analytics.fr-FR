...
+++## Pourquoi est-ce que je vois parfois des dates en dehors de mon créneau de rapport lors de l’utilisation de modèles d’attribution ?
...
+++## Les modèles d’attribution sont-ils disponibles dans d’autres fonctionnalités d’Analytics, telles que les flux de données ou le Data Warehouse ?
...
Oui, la plupart des sources de données sont prises en charge. L’attribution n’est pas possible avec les sources de données de niveau résumé, car ces sources de données ne sont pas liées à un identifiant visiteur Analytics.
...
+++## Comment l’attribution fonctionne-t-elle avec des variables à plusieurs valeurs, telles que les variables de liste ?
