...
Si le destinataire du lien n’a pas reçu de [rôle de projet](/help/analyze/analysis-workspace/curate-share/share-projects.md), les administrateurs reçoivent les expériences **[!UICONTROL Modifier l’original]** et les non-administrateurs reçoivent **[!UICONTROL Modifier la copie]**.

## Obtenir un lien en lecture seule à partager avec n’importe qui

Vous pouvez partager un lien en lecture seule vers les projets Analysis Workspace avec des personnes qui n’ont pas accès à Adobe Analytics.

Pour plus d’informations, voir [Partager avec tout le monde](/help/analyze/analysis-workspace/curate-share/share-projects.md#share-a-project-with-anyone-no-login-required).
...
If the recipient of the link has not been assigned a [project role](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/curate-share/share-projects.html?lang=fr), admins receive **[!UICONTROL Edit original]** and non-admins receive **[!UICONTROL Edit copy]** experiences.
...
[Watch the video](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/visualizations/intra-linking-in-analysis-workspace.html?lang=fr) on how to create links and use them to drive recipients to specific parts of your project. 
