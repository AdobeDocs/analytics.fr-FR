...
_Cet article présente la visualisation Ligne dans_ ![AdobeAnalytics](/help/assets/icons/AdobeAnalytics.svg) _**Adobe Analytics**._<br/>_Voir [Line](https://experienceleague.adobe.com/fr/docs/analytics-platform/using/cja-workspace/visualizations/line) pour la_ ![CustomerJourneyAnalytics](/help/assets/icons/CustomerJourneyAnalytics.svg) version _**Customer Journey Analytics** de cet article._
