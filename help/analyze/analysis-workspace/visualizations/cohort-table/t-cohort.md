...
1. Dans le [créateur de segments](https://marketing.adobe.com/resources/help/fr_FR/analytics/segment/seg_build.html), modifiez davantage le segment, puis cliquez sur **[!UICONTROL Enregistrer]**.
