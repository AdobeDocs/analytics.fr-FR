...
>title="Table de cohorte"
>abstract="Regroupez les utilisateurs et utilisatrices d’après l’exécution d’un événement, puis analysez leur engagement continu et leur taux de désabonnement au fil du temps.<br/><br/>**Paramètres &#x200B;**<br/>**Critères d’inclusion** : composants utilisés pour définir vos cohortes initiales de visiteurs et visiteuses.<br/>**Critères de retour** : composants utilisés pour savoir si un visiteur ou une visiteuse revient."
...
* Réorientez le budget marketing au moment le plus opportun du cycle de vie du client.
* Sachez reconnaître quand terminer un essai ou une offre pour en optimiser la valeur.
* Trouvez des idées de tests AB dans des domaines tels que la tarification, le chemin de mise à niveau, etc.
