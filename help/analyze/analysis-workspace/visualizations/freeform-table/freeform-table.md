...
![Tableau à structure libre présentant les composants dans les lignes et les colonnes, y compris Visites et Commandes en ligne pour plusieurs pages web.](assets/opening-section.png)
...
Si vous préférez d’abord ajouter plusieurs composants à votre tableau et effectuer ensuite le rendu des données, vous pouvez sélectionner **[!UICONTROL Activer le créateur de tableau]**. Une fois le créateur activé, vous pouvez faire glisser et déposer des dimensions, répartitions, mesures et filtres afin de créer des tableaux qui répondent à des problématiques plus complexes. Les données sont mises à jour une fois que vous avez sélectionné **[!UICONTROL Créer]**.

![Créateur de tableau à structure libre](assets/table-builder.png)
...
* Vous pouvez répartir les lignes en fonction de composants supplémentaires. Pour répartir plusieurs lignes à la fois, sélectionnez plusieurs lignes, puis faites glisser le composant suivant sur les lignes sélectionnées. En savoir plus sur la [répartition](/help/analyze/analysis-workspace/components/dimensions/t-breakdown-fa.md).
...
Sélectionnez ![Paramètre](/help/assets/icons/Setting.svg) pour afficher les **[!UICONTROL Paramètres du tableau]**. Les [paramètres](../freeform-analysis-visualizations.md#settings) de visualisation spécifiques suivants sont disponibles :
...
| Option | Description |
|---|---|
| **[!UICONTROL Aligner les dates de chaque colonne afin qu’elles commencent à la même ligne.]** | Sélectionnez cette option pour aligner les dates de chaque colonne afin qu’elles commencent toutes à la même ligne. |
...
| Option | Description |
| --- | --- |
| **[!UICONTROL Insérer une visualisation copiée]**n | Collez (ou insérez) la copie d’une visualisation à un autre emplacement au sein du projet, ou dans un tout autre projet. |
...
Voir ![VideoCheckedOut](/help/assets/icons/VideoCheckedOut.svg) [Vue d’ensemble du créateur de tableau à structure libre](https://video.tv.adobe.com/v/31318?quality=12&learn=on){target="_blank"} pour une vidéo de démonstration.
...
Voir ![VideoCheckedOut](/help/assets/icons/VideoCheckedOut.svg) [Totaux de tableaux à structure libre](https://video.tv.adobe.com/v/29273?quality=12&learn=on){target="_blank"} pour une vidéo de démonstration.
