---
title: Comment définir les préférences d’utilisateur ou d’utilisatrice et de société dans Analysis Workspace
description: Vous pouvez définir des préférences générales et de projet pour les utilisateurs et utilisatrices, ainsi qu’une préférence de thème sombre.
...
1. Dans Adobe Analytics, accédez à la page de destination [!UICONTROL **Projet**], puis sélectionnez [!UICONTROL **Préférences**].
