...
>[!AVAILABILITY]
>
>La fonctionnalité Liens d’accès publics décrite dans cette section est dans la phase Tests limités de la version. Cette note sera supprimée lorsque la fonctionnalité sera disponible. Pour plus d’informations sur le processus de publication d’Analytics, voir [Versions des fonctionnalités d’Adobe Analytics](/help/release-notes/releases.md).

Vous pouvez mettre à jour les préférences de l’entreprise qui s’appliquent à tous les utilisateurs et projets de votre entreprise. Pour plus d’informations sur l’accès à ces préférences, voir [Préférences de mise à jour](#update-preferences).

| Section | Préférence | Options |
| --- | --- | --- |
| **Onglet Rapports** |  |  |
|  | Masquer l’onglet Rapports | Masque l’onglet Rapports pour tous les utilisateurs de votre entreprise. |
| **Liens d’accès publics** <!-- Double check the names of all these settings for what they are actually called --> |  |  |
|  | Désactiver tous les liens d’accès public | <p>Empêche les utilisateurs de votre entreprise de partager des projets Analysis Workspace avec des personnes qui ne disposent pas d’un compte Analysis Workspace. Les utilisateurs peuvent partager des projets uniquement avec d’autres utilisateurs Analysis Workspace de votre entreprise.</p> <p>Lorsque les liens publics sont désactivés :</p> <ul><li><p>Les utilisateurs ne peuvent pas créer de liens d’accès publics</p><p>L’option &quot;Partager le lien public&quot; est supprimée du menu Partager . Cela signifie que les utilisateurs ne peuvent plus partager de projets avec des personnes qui n’ont pas de compte Analysis Workspace dans votre organisation, comme décrit dans la section [Partager un lien public avec quiconque (aucune connexion requise)](/help/analyze/analysis-workspace/curate-share/share-projects.md#share-public-link) in [Partage de projets](/help/analyze/analysis-workspace/curate-share/share-projects.md).</p></li> <li><p>Tous les liens publics existants sont désactivés.</p></li><p>Si les liens publics sont désactivés puis réactivés, tous les liens désactivés précédemment ne sont pas automatiquement réactivés. Dans ce cas, les utilisateurs doivent les réactiver manuellement pour chaque projet à partir de la boîte de dialogue Partager le projet .</p> |
|  | Exiger un mot de passe | <p>Impose aux utilisateurs de votre entreprise d’avoir besoin d’une protection par mot de passe lorsqu’ils créent des liens publics.</p> <p>Une fois cette option activée, chaque fois qu’un utilisateur crée un lien public vers un projet Analysis Workspace, l’option &quot;Mot de passe requis&quot; est activée dans la boîte de dialogue de partage et elle ne peut pas être désactivée par l’utilisateur. (Pour plus d’informations sur la manière dont les utilisateurs peuvent partager des projets avec des utilisateurs en dehors de l’entreprise, voir [Partager un lien public avec quiconque (aucune connexion requise)](/help/analyze/analysis-workspace/curate-share/share-projects.md#share-public-link) in [Partage de projets](/help/analyze/analysis-workspace/curate-share/share-projects.md).)</p><p>Tenez compte des points suivants lors de l’activation de cette option :</p> <ul><li><p>Lorsque vous activez cette option, tous les liens publics actuellement principaux pour lesquels la protection par mot de passe n’est pas activée sont désactivés.</p></li> <li><p>Si cette option est activée puis désactivée ultérieurement, tous les liens désactivés précédemment ne sont pas automatiquement réactivés. Dans ce cas, les utilisateurs doivent les réactiver manuellement à partir de la boîte de dialogue Partager le projet .</p></li></ul> |
|  | Exiger une authentification par authentification unique | <p>Nécessite une authentification unique (SSO) pour tous les liens publics. Lorsque cette option est activée, seuls les destinataires disposant d’un identifiant fédéré et pouvant se connecter à l’Experience Cloud peuvent accéder aux liens publics partagés.</p> <p>Une fois cette option activée, chaque fois qu’un utilisateur crée un lien vers un projet Analysis Workspace, l’option &quot;Exiger une authentification unique (SSO)&quot; est activée dans la boîte de dialogue de partage et ne peut pas être désactivée par l’utilisateur. (Pour plus d’informations sur la manière dont les utilisateurs peuvent partager des projets avec des utilisateurs en dehors de l’entreprise, voir [Partager un lien public avec quiconque (aucune connexion requise)](/help/analyze/analysis-workspace/curate-share/share-projects.md#share-public-link) in [Partage de projets](/help/analyze/analysis-workspace/curate-share/share-projects.md).)</p> <p>Tenez compte des points suivants lors de l’activation de cette option :</p><ul><li><p>Lorsque vous activez cette option, tous les liens publics actuellement principaux pour lesquels la fonction d’authentification unique n’est pas activée sont désactivés.</p></li> <li><p>Si cette option est activée puis désactivée ultérieurement, tous les liens désactivés précédemment ne sont pas automatiquement réactivés. Dans ce cas, les utilisateurs doivent les réactiver manuellement à partir de la boîte de dialogue Partager le projet .</p></li> <li><p>Cette option est disponible uniquement si SSO est implémenté dans votre entreprise. Pour plus d’informations sur la manière dont les administrateurs système peuvent activer l’authentification unique pour votre entreprise, voir [Configuration de l’identité et de l’authentification unique](https://helpx.adobe.com/fr/enterprise/using/set-up-identity.html){target=_blank}.</p><p>Si l’authentification unique est configurée pour votre organisation, vérifiez si un type de création de compte automatique est implémenté dans la console. En règle générale, un administrateur système configure cette configuration, comme décrit dans la section [Activation de la création automatique de compte](https://helpx.adobe.com/enterprise/using/automatic-account-creation.html){target=_blank}.</p></li><li><p>Si votre entreprise fait partie d’un secteur qui nécessite la conformité HIPAA, cette option est automatiquement activée et ne peut pas être désactivée.</p></li></ul> |
|  | Affichage de l’option &quot;Exiger une authentification par authentification unique&quot; pour les utilisateurs | <p>Si l’option &quot;Exiger une authentification par authentification unique&quot; est désactivée, vous pouvez sélectionner cette option pour permettre aux utilisateurs de votre entreprise de choisir s’ils souhaitent exiger une authentification par authentification unique pour les projets qu’ils partagent. Dans ce cas, chaque fois qu’un utilisateur crée un lien vers un projet Analysis Workspace, l’option &quot;Exiger une authentification unique (SSO)&quot; est activée dans la boîte de dialogue de partage. Les utilisateurs peuvent la désactiver s’ils le souhaitent.<!--or is this disabled by default?--> (Pour plus d’informations sur la manière dont les utilisateurs peuvent partager des projets avec des utilisateurs en dehors de l’entreprise, voir [Partager un lien public avec quiconque (aucune connexion requise)](/help/analyze/analysis-workspace/curate-share/share-projects.md#share-public-link) in [Partage de projets](/help/analyze/analysis-workspace/curate-share/share-projects.md).)</p><p>Si l’option &quot;Exiger une authentification par authentification unique&quot; est activée, cette option pour l’afficher aux utilisateurs est sélectionnée et ne peut pas être désélectionnée.</p><p>Tenez compte des points suivants lorsque vous sélectionnez cette option :</p><ul><li><p>Cette option est disponible uniquement si SSO est implémenté dans votre entreprise. Pour plus d’informations sur la manière dont les administrateurs système peuvent activer l’authentification unique pour votre entreprise, voir [Configuration de l’identité et de l’authentification unique](https://helpx.adobe.com/fr/enterprise/using/set-up-identity.html){target=_blank}.</p><p>Si l’authentification unique est configurée pour votre organisation, vérifiez si un type de création de compte automatique est implémenté dans la console. En règle générale, un administrateur système configure cette configuration, comme décrit dans la section [Activation de la création automatique de compte](https://helpx.adobe.com/enterprise/using/automatic-account-creation.html){target=_blank}.</p></li><li><p>Si vous sélectionnez cette option et qu’un utilisateur choisit de demander une authentification par authentification unique, seuls les destinataires qui disposent d’un identifiant fédéré et peuvent se connecter à l’Experience Cloud peuvent accéder aux liens publics partagés.</p></li></ul> |
