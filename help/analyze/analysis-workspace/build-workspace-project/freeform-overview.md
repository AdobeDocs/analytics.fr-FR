...
| [Afficher les tutoriels](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/analysis-workspace-basics/analysis-workspace-introduction.html) | Permet d’accéder aux tutoriels vidéos Analysis Workspace. |
...
| Type | Indique s’il s’agit d’un projet Workspace ou d’une [fiche d’évaluation mobile](https://experienceleague.adobe.com/docs/analytics/analyze/mobapp/home.html). |
