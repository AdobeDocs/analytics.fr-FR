...
| Afficher plus | Cette sélection révèle les options permettant de créer un projet vierge ou une fiche d’évaluation mobile, de [ visionner des tutoriels de formation](https://experienceleague.adobe.com/en/docs/analytics-learn/tutorials/analysis-workspace/analysis-workspace-basics/analysis-workspace-introduction) ou de [consulter des notes de mise à jour](/help/release-notes/latest.md). |
...
| ![Personnaliser la table](https://spectrum.adobe.com/static/icons/workflow_18/Smock_ColumnSettings_18_N.svg) | Cette icône vous permet de personnaliser les colonnes affichées pour chaque projet dans la liste des projets. |

La liste des projets peut afficher les colonnes suivantes :

| Colonne | Description |
|---|---|
| [!UICONTROL Nom] | Nom du projet Workspace. Sélectionnez ![Info](https://spectrum.adobe.com/static/icons/workflow_18/Smock_InfoOutline_18_N.svg) pour afficher une fenêtre contextuelle contenant plus de détails sur un projet ou un dossier. Sélectionnez ![Plus](https://spectrum.adobe.com/static/icons/workflow_18/Smock_More_18_N.svg) pour afficher les actions disponibles. Pour plus d’informations, voir [Gestion des projets](#manage-projects) . |
| [!UICONTROL Type] | Indique si cette entrée est un projet Workspace, un dossier ou une [Fiche d’évaluation mobile](https://experienceleague.adobe.com/en/docs/analytics/analyze/mobapp/home). |
...
| Action | Description |
|---|---|
| ![Supprimer](https://spectrum.adobe.com/static/icons/workflow_18/Smock_Delete_18_N.svg) Supprimer | Lorsqu’elle est sélectionnée, une boîte de dialogue de confirmation vous invite à confirmer la suppression d’un projet Workspace ou d’une fiche d’évaluation mobile. Sélectionnez **[!UICONTROL OK]** pour confirmer. |
| ![Share](https://spectrum.adobe.com/static/icons/workflow_18/Smock_Share_18_N.svg) Share | Cette action vous permet de partager votre projet. Voir [Partage de projets](../curate-share/share-projects.md). |
| ![Rename](https://spectrum.adobe.com/static/icons/workflow_18/Smock_Edit_18_N.svg) Rename | Ouvre une boîte de dialogue **[!UICONTROL Renommer : *nom *]**pour renommer votre projet. Sélectionnez**[!UICONTROL Enregistrer ]**pour enregistrer le nouveau nom du projet. |
| ![Copier](https://spectrum.adobe.com/static/icons/workflow_18/Smock_Copy_18_N.svg) Copier | Copie immédiatement le projet sélectionné dans un nouveau projet nommé *nom d’origine* (copie). |
| ![Pin](https://spectrum.adobe.com/static/icons/workflow_18/Smock_PinOff_18_N.svg) Pin | Immédiatement le projet est placé en haut de la liste. Ajoute l’indicateur ![Pin](https://spectrum.adobe.com/static/icons/workflow_18/Smock_PinOff_18_N.svg) . |
| Balise ![Tag](https://spectrum.adobe.com/static/icons/workflow_18/Smock_Label_18_N.svg) | Ouvre la boîte de dialogue **[!UICONTROL Projet de balise]**. Vous pouvez sélectionner une balise existante ou en ajouter de nouvelles. Sélectionnez **[!UICONTROL Enregistrer]** pour enregistrer les balises du projet. |
| ![(Un-)Approuver](https://spectrum.adobe.com/static/icons/workflow_18/Smock_CheckmarkCircle_18_N.svg) Approuver ou Ne plus approuver | Approuve ou désapprouve le projet. |
| ![Exporter CSV](https://spectrum.adobe.com/static/icons/workflow_18/Smock_FileCSV_18_N.svg) Exporter CSV | Télécharge immédiatement un fichier contenant une liste de valeurs séparées par des virgules des projets. |
| ![Déplacer vers](https://spectrum.adobe.com/static/icons/workflow_18/Smock_FolderAddTo_18_N.svg) Déplacer vers | Cette action vous permet de déplacer le projet vers un dossier. Dans la boîte de dialogue **[!UICONTROL Select Folder]**, sélectionnez un dossier dans la liste **[!UICONTROL Folder]** et sélectionnez **[!UICONTROL Move]**. |


## Barre de menus {#menu-bar}

Dans un projet, le menu fournit des options relatives à la gestion du projet, à l’ajout de composants, à la recherche d’aide et bien plus. Vous pouvez également accéder à chaque option de menu par le biais du clavier [raccourcis](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/build-workspace-project/fa-shortcut-keys).


| Élément de menu | Description |
|---|---|
| Projet    | Ce menu comprend des actions courantes pour la gestion de projet, notamment Nouveau, Ouvrir, Enregistrer sous et [Enregistrer en tant que rapport d’entreprise](/help/analyze/analysis-workspace/build-workspace-project/starter-projects.md). Vous pouvez également actualiser l’intégralité du projet pour récupérer les données et définitions les plus récentes en cliquant sur Actualiser le projet. Les options de [téléchargement CSV et PDF](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/curate-share/download-send) vous permettent d’exporter des données à partir de Workspace. Les [informations et paramètres du projet](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/build-workspace-project/freeform-overview) vous offrent de nombreuses options relatives à la gestion de votre projet. |
...
**[!UICONTROL Workspace]** > **[!UICONTROL Projet]** > **[!UICONTROL Informations et paramètres du projet]** fournit des informations sur le projet actuellement actif.
...
|---|---|
| ![Icône Panneaux](https://spectrum.adobe.com/static/icons/workflow_18/Smock_WebPage_18_N.svg) | [Panneaux](/help/analyze/analysis-workspace/c-panels/panels.md) |
...
| ![icône de toc](https://spectrum.adobe.com/static/icons/workflow_18/Smock_ViewList_18_N.svg) | [Table des matières](/help/analyze/analysis-workspace/build-workspace-project/project-table-of-contents.md) |
...
Selon le point de départ que vous avez choisi pour vos projets, vous disposez d’une [table à structure libre](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/visualizations/freeform-table/freeform-table) ou d’un [panneau vierge](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/panels/blank-panel) dans la zone de travail pour commencer. Le moyen le plus rapide de démarrer une analyse consiste à sélectionner un ou plusieurs composants, puis tout simplement à les faire glisser et les déposer dans le canevas du projet. Un tableau de données s’affiche automatiquement. [En savoir plus](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/visualizations/freeform-table/freeform-table) sur les différentes options de création d’un tableau ou utilisez le [tutoriel de formation](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/home) pour plus d’informations sur la création de votre premier projet.
