...
1. Vérifiez que vous avez sélectionné [Afficher les dossiers et les projets](/help/analyze/analysis-workspace/build-workspace-project/freeform-overview.md#show-selector).

1. Vérifiez que le dossier dans lequel vous souhaitez créer un dossier s’affiche dans la [zone de titre](/help/analyze/analysis-workspace/build-workspace-project/freeform-overview.md#title-area) et la [liste des projets](/help/analyze/analysis-workspace/build-workspace-project/freeform-overview.md#project-list).
