...
* un projet vierge (par défaut). For instructions, see [Create an Analysis Workspace Project](../../../analyze/analysis-workspace/build-workspace-project/t-freeform-project.md#task_C2C698ACC7954062A28E4784911E6CF2).
...
1. Go to **[!UICONTROL Project]** &gt; **[!UICONTROL Save As Template]**.
   ...
   >[!NOTE]
   >
   >Par défaut, les modèles de projet sont visibles par tous les membres de votre organisation. Vous pouvez organiser les modèles en leur appliquant des balises. (Go to **[!UICONTROL Project]** &gt; **[!UICONTROL Project Info &amp; Settings]** to edit tags and descriptions.)
...
Lors de l'ouverture initiale d'un espace de travail, les modèles sont disponibles dans le rail de gauche. Les modèles Analysis Workspace couvrent les cas d’utilisation courants. Ils sont groupés selon le marché vertical auquel ils appartiennent et comprennent différents segments, dimensions, mesures et visualisations, selon la suite de rapports sélectionnée.
...
>[!IMPORTANT]
>
>Les modèles mobiles sont disponibles uniquement si votre suite de rapports est activée pour Mobile.

* **Messagerie :** Se concentre sur les performances des messages in-app et push.
* **Emplacement :** Inclut une zone de données indiquant les données d'emplacement.
* **Mesures clés :** Gardez une impulsion sur les mesures clés de votre application.
* **Utilisation de l'application :** Combien d'utilisateurs de l'application, de lancements et de premiers lancements l'application a-t-elle eu et quelle était la durée moyenne de session ?
* **Acquisition :** Découvrez comment les liens d'acquisition mobile sont performants.
* **Performances :** Comment l'application est-elle performante et où les utilisateurs rencontrent-ils des problèmes ?
* **Rétention :** Qui sont mes fidèles utilisateurs et que font-ils ?
* **Parcours :** Quels sont les schémas d'utilisation les plus importants pour mon application ?

### Vente au détail

* **Performances de campagne :** Quelles sont les campagnes qui génèrent le plus de recettes ?
* **Produits :** Quels sont les produits les plus performants ?

### Web

* **Acquisition :** Quels sont les principaux pilotes de trafic sur mon site Web ?
* **Consommation de contenu :** Quels sont les meilleurs lieux sur mon site ?
* **Rétention :** Quels types d'utilisateurs sont susceptibles d'être des utilisateurs fidèles de mon site ?
* **Technologie :** Quelle technologie les utilisateurs utilisent-ils pour accéder à mon site ?
