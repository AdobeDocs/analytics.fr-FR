...
| [!UICONTROL Une erreur inattendue s&#39;est produite ; essayez de réactualiser votre projet. Si le problème persiste, envoyez cet identifiant d&#39;erreur au service à la clientèle de l&#39;Adobe pour un diagnostic plus poussé.] | Adobe rencontre un problème qui doit être résolu. | Essayez d’actualiser votre projet et si le problème persiste, envoyez le code d’erreur au service à la clientèle. |
