...
[!UICONTROL Analysis Workspace] offre un vaste ensemble de [raccourcis clavier](/help/analyze/analysis-workspace/build-workspace-project/fa-shortcut-keys.md) pour un flux de travail plus fluide.
