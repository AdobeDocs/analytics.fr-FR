...
Le premier clic démarre une sélection de plage de dates. Mettez en surbrillance la période dans l’une ou l’autre direction puis cliquez pour sélectionner la fin de la plage de dates. If the `Shift` key is held down (or right-click is used) while clicking the first date, it will append to the range.
...
[Utilisation des plages de dates et du calendrier dans Analysis Workspace sur YouTube](https://www.youtube.com/watch?v=L4FSrxr3SDA&list=PL2tCx83mn7GuNnQdYGOtlyCu0V5mEZ8sS&index=28) (4:07)
