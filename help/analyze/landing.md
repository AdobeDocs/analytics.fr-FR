...
* Les **[!UICONTROL rapports]** font référence à tout élément préconfiguré par Adobe, tel que les rapports dans Reports &amp; Analytics et les modèles dans Espace de travail. Les [!UICONTROL rapports] constituent également des modèles de rapports que votre société a créés pour vous.
* Le terme **[!UICONTROL Modèles]** nʼest plus employé pour les projets Espace de travail préconfigurés dʼAdobe. Les modèles se trouvent désormais sous [!UICONTROL Rapports].
...
| Créer un projet | Le menu déroulant vous permet de créer un [!UICONTROL projet Espace de travail] ou un [!UICONTROL projet mobile]. |
| Afficher moins/plus | Active/désactive lʼaffichage de la bannière : ![Bannière supérieure](assets/top-banner.png) |
| Projet vierge | Permet de créer un [projet Espace de travail](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/home.html?lang=fr) vierge à compléter. |
...
| Question | Réponse |
| --- | --- |
| Où sont les modèles que je suis habitué à voir dans Espace de travail ? | Ces modèles sont regroupés sous lʼonglet [!UICONTROL Rapports]. |
