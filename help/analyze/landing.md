...
| --- | --- | --- |
| Développer [!UICONTROL Projets] tableau en plein écran | Pour agrandir le tableau, il vous suffit de cliquer sur l’icône de menu du hamburger. Cette action réduit les onglets du rail gauche. | ![Développer le tableau](assets/landing-collapse.png) |
| Personnalisation de la largeur de colonne | Auparavant, la largeur de la colonne était fixe. Vous pouvez maintenant l’ajuster en faisant glisser le séparateur de colonne. |  |
...
| Nouvelles colonnes de tableau | Cliquez sur le bouton [!UICONTROL Personnalisation du tableau] en haut à droite du tableau. Les nouvelles colonnes de tableau incluent : <ul><li>**[!UICONTROL Planifié]**: Définissez sur . [!UICONTROL Activé] lorsqu’un projet est planifié ou [!UICONTROL Off] dans le cas contraire. Cliquez sur le bouton [!UICONTROL Activé] lien vous permet d’afficher des informations sur le projet planifié. Vous pouvez également [modifier le planning du projet ;](/help/analyze/analysis-workspace/curate-share/t-schedule-report.md) si vous êtes le propriétaire du projet.</li><li>**[!UICONTROL Identifiant de projet]**: L’ID de projet peut être utilisé pour le débogage des projets.</li><li>**[!UICONTROL Période la plus longue]**: Des périodes plus longues augmentent la complexité du projet et peuvent augmenter les temps de traitement et de chargement. </li><li>**[!UICONTROL Nombre de requêtes]**: Un nombre plus élevé de requêtes de projet augmente la complexité du projet et peut augmenter les temps de traitement et de chargement.</li></ul> | ![Nouvelles colonnes](assets/new-columns.png) |
...
* Le terme **[!UICONTROL Modèles]** nʼest plus employé pour les projets Espace de travail préconfigurés dʼAdobe. Les modèles se trouvent désormais sous [!UICONTROL Rapports]. Le terme [!UICONTROL Modèles] est toujours utilisée pour les modèles créés par votre entreprise.

## Accédez à lʼonglet [!UICONTROL Projets] {#navigate-projects}

Les [!UICONTROL projets] font office de page dʼaccueil de [!UICONTROL Espace de travail]. Tous les projets Espace de travail sʼaffichent ici, y compris les Fiches dʼévaluation mobiles.
...
| [!UICONTROL Créer un projet] | Le menu déroulant vous permet de créer un [!UICONTROL projet Espace de travail] ou un [!UICONTROL projet mobile]. |
...
| Question | Réponse |
| --- | --- |
| Où sont les modèles que je suis habitué à voir dans [!UICONTROL Workspace]? | Ces modèles sont regroupés sous lʼonglet [!UICONTROL Rapports]. |
| Puis-je me désinscrire du programme bêta ? | Vous pouvez vous désinscrire de la version bêta à tout moment. |
| Le travail que je fais dans l’interface utilisateur du programme bêta est-il transféré à la production ? [!UICONTROL Workspace] expérience ? | Oui, tout travail effectué dans la version bêta est transmis à l’ancienne version/actuelle. [!UICONTROL Workspace] expérience. |
| Est-ce que je suis actuellement ? [!DNL Reports & Analytics] favoris transférés ? | Non, ils ne sont PAS conservés. Cependant, tout [!UICONTROL Workspace] les favoris du projet sont reportés. |
