---
description: Explique comment la page d’entrée rassemble Analysis Workspace et Reports & Analytics dans une seule interface et un point d’accès sous l’égide de Workspace.
title: Page d’entrée Adobe Analytics
role: User, Admin
...
# Page d’entrée Adobe Analytics

La page d’entrée d’Adobe Analytics rassemble Analysis Workspace et Reports &amp; Analytics dans une seule interface et un point d’accès sous le parapluie de Workspace. Il comprend une page d’accueil du chef de projet, un menu de rapports mis à jour, des rapports modernisés et une section d’apprentissage pour vous aider à démarrer plus efficacement.
...
## Accéder à la landing page {#access-landing}

Après vous être connecté à Adobe Experience Cloud et Analytics, activez le bouton bascule [!UICONTROL Nouvelle page de destination - Beta] dans le coin inférieur gauche. L’accès au bouton d’activation/désactivation est spécifique à l’utilisateur et non à l’entreprise.
...
* Menu Analytics supérieur : La plupart des rapports se trouvent désormais dans le menu [!UICONTROL Rapports] du rail de gauche.
...
![Toutes les entrées](assets/landing-all.png)
...
| Nom | Nom du projet. |
| Icône Épingler | Vous pouvez épingler des éléments qui *apparaissent toujours* en haut de votre liste. |
...
Voici les menus et leurs sous-menus. Si vous ne trouvez pas un rapport spécifique, effectuez une « Recherche sur la page » pour le localiser.
...
## FAQ sur la landing page {#landing-faq}
