---
description: Décrit comment la page de destination rassemble Analysis Workspace et Reports & Analytics en une seule interface et un point dʼaccès sous la bannière Workspace.
...
| Afficher moins/plus | Active/désactive lʼaffichage de la bannière : ![Bannière supérieure](assets/top-banner.png) |
...
| **[!UICONTROL Rapports sur la société]** | Rapports que votre société a créés pour votre usage. Voir &quot;Créer un rapport d’entreprise&quot; ci-dessous. |

### Emplacement des modèles (désormais appelés rapports)

| Nom du rapport (modèle) | Emplacement du rapport |
| --- | --- |
| Tutoriel de formation | Tutoriel le plus populaire > Formation |
...
| Consommation audio du média | Engagement > Consommation audio du média |
| Récence, fréquence et fidélité des médias | Engagement > Récence des médias, fréquence, fidélité |
| Impact de l’ITP | Engagement > Impact ITP |
| Performances du produit | Conversion > Produits > Performance du produit |
| Magento : Marketing et commerce | Conversion > Magento : Marketing et commerce |
| Mesure Personnes | Audience > Mesure Personnes |
| Présentation de l’emplacement | Audience > Profil du visiteur > Aperçu de l’emplacement |
| Présentation de la technologie | Audience > Profil du visiteur > Technologie > Aperçu de la technologie |
| Utilisation des applications mobiles | Audience > Mobile > Utilisation de l’application mobile |
| Parcours d’applications mobiles | Audience > Mobile > Parcours d’applications mobiles |
| Mesures des applications mobiles | Audience > Mobile > Mobile App Messaging |
| Performances des applications mobiles | Audience > Mobile > Performances de l’application mobile |
| Rétention des applications mobiles | Audience > Mobile > Rétention des applications mobiles |
...
| Advertising Analytics : Recherche payante | Acquisition > Advertising Analytics : Recherche payante |
...
Les rapports personnalisés, appelés Rapports d’entreprise, se trouvent dans le menu Rapports d’entreprise (voir ci-dessous). Tous les nouveaux et les anciens sont répertoriés ici.

Pour créer un rapport Société, procédez comme suit :

1. Créez l’espace de travail à l’état souhaité.
1. Ouvrez le menu [!UICONTROL Projet] et cliquez sur **[!UICONTROL Enregistrer en tant que rapport de société..]**.

   ![Rapport sur la société](assets/company-report.png)

1. Ajoutez tous les champs de votre choix au modal et enregistrez-le.

   Le rapport est ajouté à la liste Rapports d’entreprise et est disponible pour les utilisateurs de votre société de connexion.
