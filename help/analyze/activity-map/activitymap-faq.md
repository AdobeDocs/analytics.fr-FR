...
seo-title: Questions fréquentes sur Carte d’activités
solution: Analytics
...
Un message d'avertissement s'affiche indiquant que vous devez demander à votre administrateur\ [Activer le rapport Carte d'activités\] (/home/analyze/activity-map/activitymap-getting-started/activitymap-getting-started-admins/activitymap-enable. md).
...
A : Carte d'activités hérite de vos segments de niveau administrateur (segments de création de rapports) à partir d'Analytics.
