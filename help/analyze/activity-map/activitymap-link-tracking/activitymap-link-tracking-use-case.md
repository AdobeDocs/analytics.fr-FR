...
>[!NOTE]
>
>Vous n’êtes pas strictement limité au paramètre "id" comme identifiant de région. Vous pouvez également définir votre propre identifiant à l’aide de la variable JavaScript "s.ActivityMap.regionIDAttribut".
