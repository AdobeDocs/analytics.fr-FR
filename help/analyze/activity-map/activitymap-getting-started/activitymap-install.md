...
title: Installation des extensions de navigateur de Activity Map
...
# Installation des extensions de navigateur de Activity Map

Le processus d’installation varie en fonction du navigateur que vous utilisez.

Extensions du navigateur du Activity Map :
...
* Sont uniquement compatibles avec les dernières versions des navigateurs de bureau suivants : Firefox et Chrome.
...
* Vous devez passer par un processus d’installation de l’extension de navigateur.

## Installation de l’extension Activity Map sur Chrome {#chrome}
...
1. Cliquez sur **[!UICONTROL Ajouter une extension]**.
   ![Ajout de l’extension Chrome](assets/chrome1.png)
