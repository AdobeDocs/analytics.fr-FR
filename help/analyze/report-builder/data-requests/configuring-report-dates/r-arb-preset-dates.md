...
Cette option permet de sélectionner des dates courantes ou des dates que vous avez enregistrées. Sélectionnez Préconfigurer les dates dans le formulaire Assistant Requête Étape 1. Voici les définitions de champs pour les dates prédéfinies dans le créateur de rapports.
