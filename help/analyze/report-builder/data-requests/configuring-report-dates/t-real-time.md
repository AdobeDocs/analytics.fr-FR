...
1. Assurez-vous que la création de rapports en temps réel est activée dans les [outils d’administration](https://docs.adobe.com/content/help/en/analytics/admin/admin-tools/real-time-reports/t-realtime-admin.html) dans les rapports et analyses marketing.
1. Sur la [!UICONTROL Request Wizard: Step 1]page, cliquez sur **[!UICONTROL Real-Time Report]** > **[!UICONTROL `<report type>`]**

   Par exemple, sélectionnez un rapport de trafic. When you select a real-time report type, the [!UICONTROL Select Time Range] options display.
