...
1. Activez l’option **[!UICONTROL Connexion active du service Power BI]** et cliquez sur **[!UICONTROL OK]**. ![Cliquez sur Power BI Service Live Connection, puis sur OK. ](assets/bi-preview-features.png)
...
Pour plus d’informations, voir [Article de blog Microsoft](https://powerbi.microsoft.com/en-us/blog/connecting-to-datasets-in-the-power-bi-service-from-desktop/).
