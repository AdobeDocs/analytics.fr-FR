...
description: En savoir plus sur les fonctionnalités de Report Builder.
role: User
...
Avec Report Builder pour Adobe Analytics, vous pouvez :
...
Report Builder pour Adobe Analytics est un complément Microsoft pour Excel. Le complément est disponible sur les plateformes suivantes :
...
## Report Builder hérité

Ce Report Builder remplace le [complément Report Builder hérité](/help/analyze/legacy-report-builder/home.md) et présente plusieurs avantages :
...
### Utilisation des deux versions côte à côte
...
### Fonctionnalités Report Builder héritées non prises en charge

Certaines [fonctionnalités de l’ancien Report Builder ne sont pas prises en charge](convert-workbooks.md#legacy-report-builder-features-not-supported) dans ce Report Builder.
...
>[!IMPORTANT]
>
>Cette vidéo de vue d’ensemble présente l’interface d’utilisation de Report Builder dans Customer Journey Analytics. Certaines parties de l’interface utilisateur et de la terminologie diffèrent lorsque vous utilisez Report Builder dans Adobe Analytics. Pour le reste, l’expérience d’utilisation est identique.
...
Vous pouvez télécharger Report Builder depuis Adobe Analytics à partir du [Microsoft Store](https://appsource.microsoft.com/fr-fr/product/office/WA200003101?tab=Overview).
