...
Les mesures sont des valeurs numériques. Il s’agit d’informations quantitatives sur   de votre site Web, telles que [!UICONTROL Page Views], [!UICONTROL Visitor Profile], [!UICONTROL Click-throughs], [!UICONTROL Reloads], [!UICONTROL Average Time Spent], [!UICONTROL Date], [!UICONTROL Units], etc. Le Report Builder classe les mesures dans plusieurs groupes, conformes au regroupement standard utilisé dans Analytics :
