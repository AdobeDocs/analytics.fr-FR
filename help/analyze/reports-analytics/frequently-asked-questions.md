...
title: Questions fréquentes sur les Reports & Analytics
...
+++Pourquoi un rapport vierge s’affiche-t-il alors que je sais que des données sont collectées ?
...
* Vérifiez la période : les périodes, en particulier celles qui démarrent avant la politique de conservation des données de votre entreprise, peuvent ne pas renvoyer de données. Vérifiez que la période est correctement définie.
...
+++Pourquoi y a-t-il un retard majeur dans les rapports ?
...
+++Pourquoi la version de l’appareil n’apparaît-elle pas sur les iPhone ?
...
+++Pourquoi les totaux au bas de mon rapport ne correspondent-ils pas lorsque j’additionne les valeurs ?
...
+++Comment exclure des données d’une adresse IP spécifique dans ma suite de rapports ?
...
+++Pourquoi mon segment ne s’affiche-t-il pas en Data Warehouse ?
