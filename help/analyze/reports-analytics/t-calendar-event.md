...
seo-description: Étapes permettant d’ajouter des événements de calendrier et de gérer des événements partagés.
seo-title: Événements calendrier
solution: Analytics
...
1. (Facultatif) Poussez l’événement de calendrier vers les utilisateurs. Les événements de calendrier marqués comme partagés sont maintenant dotés d’une option permettant de transmettre une option vers d’autres utilisateurs. Ce faisant, les événements concernés s’afficheront sur les graphiques de tendances et d’heures supplémentaires des destinataires.
...
1. Sous Calendrier des événements partagés, indiquez l’une de ces options :
       ...
       | ** Copiez-moi** | Ajoute une copie à votre liste d'événements, en utilisant le même nom que l'original. Néanmoins, vous ne pouvez pas voir les mises à jour/modifications effectuées par le propriétaire de l’événement. |
       |---|---|
