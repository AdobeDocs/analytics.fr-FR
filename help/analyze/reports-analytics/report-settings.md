...
| Afficher les données « Toutes les autres » dans les graphiques sélectionnés | Cette option affiche toutes les autres données au-dessous des cinq premières regroupées dans un objet unique (les graphiques à barres affichent les cinq premières pages web ou d’autres données dans votre rapport). |
