...
Pour obtenir plus de détails sur les rapports individuels, voir [Description des rapports](https://experienceleague.adobe.com/docs/analytics/components/variables/c-variables.html).
