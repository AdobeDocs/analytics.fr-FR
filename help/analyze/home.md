...
* **[!UICONTROL Ad Hoc Analysis] :** Application Java autonome avec de puissantes fonctionnalités de reporting. Cet outil n’est plus mis à jour et sera bientôt rendu caduc.
* **[!UICONTROL Reporting API] :** Créez des requêtes de rapport directement sur les serveurs d’Adobe et obtenez des réponses à utiliser dans vos outils de création de rapports client.
