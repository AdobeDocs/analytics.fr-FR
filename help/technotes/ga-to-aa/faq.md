...
1. Utilisez la combinaison ctrl+clic (Windows) ou cmd+clic (Mac) sur les composants à inclure dans le filtre déroulant. Vous ne vous limitez pas aux segments ; tout composant peut être inclus dans un filtre déroulant.
