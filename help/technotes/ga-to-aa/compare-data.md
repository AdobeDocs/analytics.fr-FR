...
* **Audit assisté et validation des données avec Adobe Consulting** : si vous souhaitez qu’un représentant officiel d’Adobe effectue un audit complet de l’implémentation sur votre site, contactez l’équipe chargée de votre compte Adobe. Il peut organiser une réunion avec un conseiller en mise en œuvre qui peut contrôler votre site en fonction du contrat de votre société.
