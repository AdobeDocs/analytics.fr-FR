...
* **Audit assisté et validation des données avec Adobe Consulting**: Si vous souhaitez qu’un représentant officiel de l’Adobe effectue un audit complet de la mise en oeuvre sur votre site, contactez votre équipe de compte d’Adobe. Il peut organiser une réunion avec un conseiller en mise en œuvre qui peut contrôler votre site en fonction du contrat de votre société.
