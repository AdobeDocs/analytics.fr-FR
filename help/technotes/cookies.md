...
Le cookie hérité `s_vi` d’Analytics en tant que cookie tiers, y compris les cibles de collecte d’adobedc.net, 2o7.net ou omtrdc.net, continue d’être bloqué en fonction des versions antérieures d’ITP.
