...
+ [](home.md)
+ 
+ [Comptes et suites de rapports](landing.md)
+ Personnalisation de l’affichage des comptes rendus des performances{#analysis-workspace}
   + [Rapports Google Analytics {#reports}](analysis-workspace/home.md)
   + [Création d’un rapport de base dans Analysis Workspace pour les utilisateurs de GA](analysis-workspace/new-features-in-analysis-workspace.md)
   + Mesures courantes utilisées sur d’autres plateformes d’analyse{#build-workspace-project}
      + [Temps réel](analysis-workspace/build-workspace-project/freeform-overview.md)
      + [Audience](analysis-workspace/build-workspace-project/save-projects.md)
      + [Adquisición](analysis-workspace/build-workspace-project/starter-projects.md)
      + [Comportement](analysis-workspace/build-workspace-project/multiple-report-suites.md)
      + [Conversions](analysis-workspace/build-workspace-project/fa-shortcut-keys.md)
      + [Questions fréquentes](analysis-workspace/build-workspace-project/color-palettes.md)
      + [Traitement des différences entre plateformes](analysis-workspace/build-workspace-project/view-density.md)
   + Comparaison des données avec des produits tiers{#components}
      + [Analyse des données affectées par les événements {#event}](analysis-workspace/components/analysis-workspace-components.md)
      + Analyse des données affectées par les événements - présentation {#annotations}
         + [Résolution des problèmes liés aux pics/baisses de données](analysis-workspace/components/annotations/overview.md)
         + [Exclusion de dates spécifiques dans l’analyse](analysis-workspace/components/annotations/create-annotations.md)
         + [Comparaison de dates aux plages précédentes](analysis-workspace/components/annotations/manage-annotations.md)
         + [Dérivation de données affectées par les événements](analysis-workspace/components/annotations/view-annotations.md)
      + Communication d’événements aux utilisateurs{#dimensions}
         + [Lissage des données intelligent](analysis-workspace/components/dimensions/view-dimensions.md)
         + [Cookies {#cookies}](analysis-workspace/components/dimensions/t-breakdown-fa.md)
         + [Cookies de navigateur](analysis-workspace/components/dimensions/time-parting-dimensions.md)
      + [Options pour atténuer l’effet des restrictions des cookies de navigateur](analysis-workspace/components/apply-create-metrics.md)
      + Rétention des données{#segments}
         + [Exclure des données](analysis-workspace/components/segments/t-freeform-project-segment.md)
         + [Adresses IP et domaines utilisés par Adobe Analytics](analysis-workspace/components/segments/quick-segments.md)
         + [Latence](analysis-workspace/components/segments/ad-hoc-segments.md)
      + Valeur de faible trafic{#calendar-date-ranges}
         + [Migration des règles de traitement Mobile Services vers Adobe Analytics](analysis-workspace/components/calendar-date-ranges/calendar.md)
         + [Prise en charge multidevise](analysis-workspace/components/calendar-date-ranges/custom-date-ranges.md)
         + [Confidentialité - Présentation](analysis-workspace/components/calendar-date-ranges/time-comparison.md)
   + Applications web progressives{#visualizations}
      + [Redirections et alias](analysis-workspace/visualizations/freeform-analysis-visualizations.md)
      + [Collecte de données régionales {#rdc}](analysis-workspace/visualizations/t-sync-visualization.md)
      + Aide sur la collecte de données régionales{#freeform-table}
         + [Obtention de certificat SSL](analysis-workspace/visualizations/freeform-table/freeform-table.md)
         + Algorithmes de chiffrement HTTPS pris en charge{#column-row-settings}
            + [Ressources de sécurité](analysis-workspace/visualizations/freeform-table/column-row-settings/column-settings.md)
            + [Termes utilisés (glossaire)](analysis-workspace/visualizations/freeform-table/column-row-settings/table-settings.md)
            + [Horodatages facultatifs](analysis-workspace/visualizations/freeform-table/column-row-settings/manual-vs-dynamic-rows.md)
         + [Résolution des problèmes de connexion](analysis-workspace/visualizations/freeform-table/pagination-filtering-sorting.md)
         + [Résolution des problèmes de déconnexion](analysis-workspace/visualizations/freeform-table/workspace-totals.md)
      + Non spécifié, Autre et Inconnu{#cohort-table}
         + [Migration des visiteurs](analysis-workspace/visualizations/cohort-table/cohort-analysis.md)
