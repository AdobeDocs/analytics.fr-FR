...
| Informations de géolocalisation | Adobe offre la possibilité d’empêcher un emplacement géographique détaillé en définissant le dernier octet d’une adresse IP sur 0. Cela rend les informations géographiques moins précises et peut être défini dans [paramètres de suite de rapports](https://experienceleague.adobe.com/docs/analytics/admin/admin-tools/manage-report-suites/edit-report-suite/report-suite-general/general-acct-settings-admin.html?lang=en). | [Villes](../components/dimensions/cities.md), [Régions](../components/dimensions/regions.md), [Pays](../components/dimensions/countries.md) |
