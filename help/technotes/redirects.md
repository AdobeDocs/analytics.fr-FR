...
Ces variables seront représentées comme les paramètres suivants dans le [débogueur Experience Cloud](https://docs.adobe.com/content/help/fr-FR/experience-cloud/user-guides/home.translate.html).
