...
1. **Mettre à jour tous les plug-ins** : veillez à utiliser la dernière version de chaque plug-in répertorié dans votre fichier `s_code.js`. Cette étape comprend les modules Media et Integrate .
