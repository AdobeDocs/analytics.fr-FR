...
4. Lorsque toutes les variables de niveau page sont définies, envoyez les données à Adobe à l’aide de la `t` fonction. Voir [t](../vars/functions/t.md) pour plus d’informations.
