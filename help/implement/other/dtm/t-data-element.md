...
1. Renseignez les champs et options suivants :
   ...
   Voir [Éléments de données](https://docs.adobe.com/content/help/fr-FR/dtm/using/resources/data-elements.html) dans la documentation du produit Tag Management d’Adobe pour plus d’informations sur l’utilisation des éléments de données.
