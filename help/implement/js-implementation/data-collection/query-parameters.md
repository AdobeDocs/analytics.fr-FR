...
seo-title: Paramètres de requête de la collecte de données
solution: Analytics
...
<table id="table_5442E15BF0AE4BDA92DDADD1C08F7C13"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> Aucun </td> 
   <td> Aucun </td> 
   <td> URL de la page activejusqu’à 255 octets </td> 
  </tr> 
  <tr> 
   <td> -g </td> 
   <td> Aucun </td> 
  ...
  <tr> 
   ...
   <td> <p>Le paramètre <code>t</code> est au format suivant : </p> 
    <code>
      jj/mm/aaaa&amp;nbsp;hh:mm:ss&amp;nbsp;D&amp;nbsp;OFFSET 
    </code> <p>Où D est un chiffre compris entre <code>0 et 6</code> qui indique le jour de la semaine et où <code>OFFSET</code> représente : </p> 
    <code>
      offset&amp;nbsp;from&amp;nbsp;GMT&amp;nbsp;in&amp;nbsp;hours&amp;nbsp;*&amp;nbsp;60&amp;nbsp;*&amp;nbsp;-&amp;nbsp;1 
    </code> <p> Par exemple : </p> 
    <code>
  ...
  <tr> 
   ...
   <td> Aucun </td> 
   <td> ID unique du visiteur comme défini dans la variable d’identifiant visiteur. </td> 
  </tr> 
  <tr> 
   <td> vmk </td> 
   <td> s.vmk </td> 
