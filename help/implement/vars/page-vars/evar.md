...
Vous pouvez définir des eVars lors de la configuration de l’extension Analytics (variables globales) ou dans les règles.
...
Chaque eVar est une chaîne qui contient des valeurs personnalisées propres à votre organisation. Leur longueur maximale est de 255 octets ; les valeurs dépassant 255 octets sont automatiquement tronquées lorsqu’elles sont envoyées à Adobe.
