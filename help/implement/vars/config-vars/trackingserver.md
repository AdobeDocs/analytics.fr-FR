...
>[!NOTE] N’utilisez aucun sous-domaine plus profond que `example.sc.omtrdc.net`. Par exemple, `custom.example.sc.omtrdc.net` n’est pas un serveur de suivi valide.
