...
1. Créez la suite de rapports globale dans Adobe Analytics. Voir [Création d’une suite de rapports](/help/admin/c-manage-report-suites/c-new-report-suite/t-create-a-report-suite.md) dans le guide d’utilisation destiné à l’administrateur pour en savoir plus.
