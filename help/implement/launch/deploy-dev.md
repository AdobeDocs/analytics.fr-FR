...
3. Cliquez sur **[!UICONTROL Hôtes]**, puis sur **[!UICONTROL Ajouter un hôte]**.
4. Nommez-le `"Adobe managed"` et sélectionnez **[!UICONTROL Géré par Adobe]** dans la liste déroulante de type. Cliquez sur Enregistrer.
5. Accédez à **[!UICONTROL Environnements]**, puis cliquez sur **[!UICONTROL Ajouter un environnement]**.
6. Sélectionnez **[!UICONTROL Développement]**, donnez-lui `"Dev Environment"` nom, puis sélectionnez l’hôte géré Adobe dans la liste déroulante. Cliquez sur **[!UICONTROL Enregistrer]**.
7. Une fenêtre modale s’affiche, affichant les instructions d’installation Web. Nous reviendrons à cette fenêtre ultérieurement. Pour l’instant, cliquez sur **[!UICONTROL Fermer]**.
8. Cliquez sur **[!UICONTROL Ajouter un environnement]**, sélectionnez **[!UICONTROL Évaluation]**, nommez-le `"Staging Environment"`, puis sélectionnez l’hôte géré Adobe. Cliquez sur **[!UICONTROL Créer]**, puis fermez la fenêtre modale des instructions d’installation.
9. Cliquez de nouveau sur **[!UICONTROL Ajouter un environnement]**, sélectionnez **[!UICONTROL Production]**, donnez-lui `"Production Environment"` nom, puis sélectionnez l’hôte géré Adobe. Cliquez sur **[!UICONTROL Créer]**, puis fermez la fenêtre modale des instructions d’installation.
...
1. Connectez-vous à [la collecte de données Adobe Experience Platform](https://experience.adobe.com/data-collection) à l’aide de vos identifiants Adobe ID.
2. Cliquez sur la propriété de balise que vous prévoyez d’implémenter sur votre site.
3. Cliquez sur l’onglet **[!UICONTROL Flux de publication]**, puis sur **[!UICONTROL Ajouter une bibliothèque]**. Voir [Présentation de la publication](https://experienceleague.adobe.com/docs/experience-platform/tags/publish/overview.html?lang=fr) dans la documentation sur les balises pour plus d’informations sur cette page.
...
7. De retour sur l’écran du workflow de publication, cliquez sur la liste déroulante en regard de votre nouvelle bibliothèque, puis cliquez sur **[!UICONTROL Créer pour développement]**. Au bout de quelques secondes, le point jaune de la bibliothèque devient vert, ce qui indique que la création a réussi.
8. Accédez à **[!UICONTROL Environnements]**, puis cliquez sur l’icône d’installation à droite de votre environnement de développement. Cette action réaffiche la fenêtre modale Instructions d’installation web .
9. Copiez le ou les blocs de code et fournissez-les aux propriétaires du site web de votre organisation.
