...
| mobileappperformance ancecrashid | Utilisé dans le connecteur de données Apteligent. ID de plantage utilisé dans Apteligent. | varchar(255) |
...
| mobiledeeplinchild | Collecté à partir de la variable de données contextuelles a.<span>deeplink</span>.id. Utilisé dans les rapports d’acquisition en tant qu’identifiant du lien d’acquisition mobile. | varchar(255) |
...
| mobilerelaunchcampaign content | Contenu de lancement de Mobile Services | varchar(255) |
| mobilerelaunchcampaign medium | Moyenne de lancement des services mobiles | varchar(255) |
| mobilerelaunchcampaign source | Source de lancement Mobile Services | varchar(255) |
| mobilerelaunchcampaign | Terme de lancement des services mobiles | varchar(255) |
| mobilerelaunchcampaign trackingcode | Collecté à partir de la variable de données contextuelles a.launch.campaign.trackingcode. Utilisé dans acquisition comme code de suivi pour la campagne de lancement. | varchar(255) |
...
| videoaudioauteur | Auteur audio vidéo | varchar(255) |
