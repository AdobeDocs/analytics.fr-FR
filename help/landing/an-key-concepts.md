...
| Data Workbench (anciennement Insight) | Permet de collecter, de traiter, d’analyser et de visualiser des données issues d’interactions d’utilisateurs en ligne et hors ligne sur plusieurs canaux. | [Client Data Workbench](https://experienceleague.adobe.com/docs/data-workbench/using/client/t-open-ins.html?lang=fr) |
...
| Attributs du client | Données de gestion de la relation client transférées vers Experience Cloud pour une utilisation dans Adobe Analytics et Adobe Target. | [Attributs du client](https://experienceleague.adobe.com/docs/core-services/interface/customer-attributes/attributes.html?lang=fr) |
