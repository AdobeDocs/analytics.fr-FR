...
seo-title: L’ID de transaction
solution: Analytics
subtopic: Sources de données
title: L’ID de transaction
...
| Canal | Nom du canal. |
| Evarn | Nom evarn. Valeurs valides de n : nombre entier entre 1 et 250. |
...
| Événement n | Nombre d’occurrences de l’événement n. Valeurs valides de n : nombre entier entre 1 et 1000.  Si vous définissez un événement de consultation, vous devez également définir la portée de données correspondante (eVar). Si, par exemple, vous incluez des consultations eVar2, vous devez configurer la variable eVar2. |
| Vues evarn | Nombre de fois où la variable eVar n a été consultée. Valeurs valides de n : nombre entier entre 1 et 250. |
