...
| events | events | [Chaîne d’événements](https://experienceleague.adobe.com/docs/analytics/implementation/vars/page-vars/events/event-serialization.html?lang=fr), formatée selon la même syntaxe que la variable s.events. Par exemple : scAdd,event1,event7 |
...
| marketingCloudVisitorID | Non pris en charge | Experience Cloud ID. Voir [Identification des visiteurs](https://experienceleague.adobe.com/docs/id-service/using/home.html?lang=fr) et le service d’identification des visiteurs par Experience Cloud |
