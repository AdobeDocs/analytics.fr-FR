...
1. Une fois le fichier .fin téléchargé, vous devez vous déconnecter du site FTP de sources de données. Vous créerez ainsi un événement de déconnexion, qui sert de déclencheur pour indiquer à Analytics que les fichiers sont prêts à être traités.
