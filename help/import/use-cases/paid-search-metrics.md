...
1. Maintenant, « mappez » cette nouvelle source de données aux événements personnalisés que nous avons créés dans [Configurer les événements de succès](/help/admin/admin/c-success-events/t-success-events.md).
