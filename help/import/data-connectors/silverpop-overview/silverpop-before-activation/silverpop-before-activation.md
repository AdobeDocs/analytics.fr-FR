...
Examinez les informations suivantes sur cette intégration de Connector de données en ce qui concerne Silverpop :
...
Cette intégration des Connecteurs de données comprend des considérations de prix que vous devez prendre en compte avant de procéder à l’activation.
...
Cette intégration peut entraîner des frais. Veuillez contacter votre gestionnaire de relations pour obtenir des informations sur les tarifs.