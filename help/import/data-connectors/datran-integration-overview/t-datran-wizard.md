...
1. Sur la page Connecteurs de données, sélectionnez la suite de rapports dans laquelle vous souhaitez configurer l'intégration.
   ...
   >[!NOTE]
   >
   >Assurez-vous de sélectionner une suite de rapports dans la **liste déroulante Suite** de rapports située dans le coin supérieur gauche de la page Connecteurs de données.
...
1. Faites glisser l'icône **Datran** vers un emplacement de module complémentaire vide dans votre suite de rapports Adobe Analytics pour lancer l'assistant d'intégration des connecteurs de données.

1. Sur la page d'introduction à l'intégration Datran, passez en revue le texte, puis cochez la case permettant d'accepter les frais associés à l'intégration, puis cliquez sur **Suivant**.
...
<table id="table_74EC1EEBE7A548AB878AA40187EBCD30"> 
 ...
 <tbody> 
  ...
  <tr valign="top"> 
   ...
   <td colname="col3"> <p>Indiquez votre ID de compte Datran (identifiant unique attribué à votre organisation par Datran), puis cliquez sur <b>Suivant</b> pour passer à l'étape 3 de l'assistant. </p> </td> 
  </tr> 
  <tr valign="top"> 
