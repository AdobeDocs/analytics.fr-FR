...
Cette intégration peut entraîner des frais récurrents et d’implémentation. Veuillez contacter [!DNL ~le partenaire~] pour obtenir des informations sur les tarifs.
...
Après avoir identifié l’événement et les eVars à utiliser avec cette intégration, ils doivent être activés dans la console d’administration d’Adobe Analytics (voir Suites [de](https://docs.adobe.com/content/help/en/analytics/admin/manage-report-suites/report-suites-admin.html) rapports pour obtenir des instructions).