...
seo-description: Les mesures suivantes sont synchronisées dans le cadre de l'intégration appfigures.
seo-title: Mesures et dimensions
title: Mesures et dimensions
uuid: 419 a 9031-1291-4 ec 0-a 2 e 1-93993858991 a
index: y
internal: n
snippet: y
...
| Achats de boutique d'applications (dans l'application) | Nombre d'achats In-App. |
| Classement de la boutique d’applications | Utilisé pour définir la mesure calculée appfigures moyenne. Pas utilisé directement. |
| Diviseur de classement de la boutique d’applications | Utilisé pour définir la mesure calculée appfigures moyenne. Pas utilisé directement. |
| Evaluation de la boutique d’applications | Utilisé pour définir la mesure calculée appfigures moyenne. Pas utilisé directement. |
| Diviseur d’évaluations de la boutique d’applications | Utilisé pour définir la mesure calculée appfigures moyenne. Pas utilisé directement. |
| Recettes de la boutique d'applications (dans l'application) | Montant des recettes in-app. |
| Recettes de la boutique d'applications (une désactivée) | Montant des recettes associées à l’achat d’une application. |
| Redevances de la boutique d'applications (dans l'application) | Obsolète. |
| Redevances de la boutique d'applications (une désactivée) | Obsolète. |

Les dimensions de classification réservées suivantes sont créées par l'assistant Connecteurs de données pour l'evar réservée appfigures.

| Dimension de classification | Description |
|---|---|
| Nom du pays | Nom du pays associé à l'activité de la boutique d'applications. |
| Nom du périphérique | Nom du périphérique mobile lié à l'activité de la boutique d'applications. |
| Nom de la boutique d'applications | Nom de l'appstore qui a signalé l'activité. |
| Nom de l’application | Nom de l'application mobile. |
| Nom intégré | Article acheté dans l'application. |
| Nom de catégorie  | Catégorie principale de l'application dans l'App Store. |
| Titre de révision | Titre de la révision. |
| Commentaire de révision | Commentaire de la révision |
...
La mesure calculée suivante est créée par l'assistant Connecteurs de données :

<table id="table_504271ED1A954CCAA234738B07EDDF27"> 
 <thead> 
  <tr> 
   <th colname="col1" class="entry"> Mesure calculée </th> 
   <th colname="col2" class="entry"> Description </th> 
  </tr> 
 </thead>
 <tbody> 
  <tr> 
   <td colname="col1"> Classement moyenne de la boutique d'applications (numérique) </td> 
   <td colname="col2"> <p>Classement moyen des applications. Cette mesure calculée est définie à l’aide de la formule suivante : </p> <code> [App &amp; amp ; nbsp ; Store &amp; amp ; nbsp ; Classement] &amp; amp ; nbsp ; /&amp; amp ; nbsp ; [App &amp; amp ; nbsp ; Store &amp; amp ; nbsp ; Rang et amp ; nbsp ; Diviseur] </code> <p>Remarque : Le nombre d'applications classées par catégorie et par pays varie d'un magasin d'applications à l'autre. Si le classement de votre application est inférieur à ce seuil, les classements d'application ne sont pas disponibles. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Note moyenne de la boutique d’applications </td> 
   <td colname="col2"> Note moyenne de l'application. Cette mesure calculée est définie à l'aide de la formule suivante : <code> [App &amp; amp ; nbsp ; Store &amp; amp ; nbsp ; Rating] &amp; amp ; nbsp ; /&amp; amp ; nbsp ; [App &amp; amp ; nbsp ; Store &amp; amp ; nbsp ; Rating &amp; amp ; nbsp ; Diviseur] </code> </td> 
  </tr> 
 </tbody> 
</table>
...
Le tableau suivant indique les dimensions de rapport liées aux mesures.
...
<table id="table_B9CF57EABE22449FBF1963E3F105E702"> 
 <tbody> 
  <tr> 
   ...
   <td> Achats de boutique d'applications (in-app) </td> 
   ...
   <td colname="col9"> Recettes de la boutique d'applications (ponctuel) </td> 
   <td colname="col10"> Classement moy. de la boutique d’applications </td> 
   <td colname="col11"> Note moyenne de la boutique d'applications </td> 
  </tr> 
  <tr> 
   <td> Nom du pays </td> 
  ...
  <tr> 
   <td> Nom de catégorie de classement </td> 
