...
* Après avoir exécuté l’assistant Connecteurs de données, contactez votre gestionnaire de compte emarsys pour activer l’intégration dans votre suite eMarketing de emarsys.
