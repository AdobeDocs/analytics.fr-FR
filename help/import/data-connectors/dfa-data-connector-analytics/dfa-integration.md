...
<table id="table_8F6F7F304C36431DA5FD6E5D54F60FC0"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Événement de compteur Analytics qui s’incrémente chaque fois que le délai <span class="varname"> s.maxDelay </span> timer expires, and no response was received from the DFA servers. Use this event to configure the <span class="varname"> s.maxDelay </span> variable Tuning s.maxDelay </a>.) </p> </td> 
  </tr> 
 </tbody> 
</table>
...
1. Exécutez une [!DNL Daily Unique Visitors Report] pour la période.
