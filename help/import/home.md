...
* **[API Bulk Data Insertion](/help/import/bulk-data-insertion-api/bulk-data-insert.md)** vous permet de charger des données d’appel au serveur par lots de fichiers au lieu d’utiliser des bibliothèques côté client telles qu’AppMeasurement.
