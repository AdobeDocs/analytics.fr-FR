...
> [!NOTE] La documentation [sur les suites de rapports](/help/components/vrs/c-workflow-vrs/vrs-create.md) virtuelles vous explique comment créer des suites de rapports virtuelles.
