...
+ Adobe Admin Console {#admin-console} {#admin-console}
   ...
   + Résumé des autorisations pour les outils Analytics {#permissions} {#permissions}
...
+ Outils d’administration Analytics {#admin-tools} {#admin-tools}
   ...
   + Personne responsable des activités de rapport {#reporting-activity-manager} {#reporting-activity-manager}
   ...
   + Migration des composants {#component-migration} {#component-migration}
   ...
   + Gestionnaire de suites de rapports {#manage-report-suites} {#manage-report-suites}
      + Modifier les paramètres d’une suite de rapports {#edit-report-suite} {#edit-report-suite}
         + Général {#report-suite-general} {#report-suite-general}
            ...
            + Détection de référencement payant {#paid-search-detection} {#paid-search-detection}
            ...
            + Règles de traitement {#c-processing-rules} {#c-processing-rules}
               ...
               + Règles de traitement {#c-processing-rules-configuration} {#c-processing-rules-configuration}
               ...
               + Exemples de règles de traitement {#processing-rules-examples} {#processing-rules-examples}
            ...
            + Règles de robots {#bot-removal} {#bot-removal}
            ...
            + Transfert côté serveur {#server-side-forwarding} {#server-side-forwarding}
         ...
         + Trafic {#traffic-variables} {#traffic-variables}
         ...
         + Conversion {#conversion-variables} {#conversion-variables}
            ...
            + Variable de visiteur unique {#unique-visitor-variable} {#unique-visitor-variable}
            ...
            + [Événements de succès](admin/c-manage-report-suites/c-edit-report-suites/conversion-var-admin/c-success-events/success-event.md)
         ...
         + Canaux marketing {#marketing-channels} {#marketing-channels}
         ...
         + Gestion du trafic {#traffic-management} {#traffic-management}
         ...
         + Gestion des applications {#app-management} {#app-management}
         ...
         + Gestion de Document Cloud {#doc-cloud-mgt} {#doc-cloud-mgt}
         ...
         + Temps réel {#real-time-reports} {#real-time-reports}
      ...
      + Nouvelle suite de rapports {#c-new-report-suite} {#c-new-report-suite}
      ...
      + Modèles de suite de rapports {#report-suite-templates} {#report-suite-templates}
   ...
   + Paramètres de l’entreprise {#company-settings} {#company-settings}
   ...
   + Étiquetage de confidentialité de la gouvernance des données {#data-governance} {#data-governance}
      ...
      + Étiquetage des données {#data-labels} {#data-labels}
   ...
   + Utilisation des appels au serveur {#server-call-usage} {#server-call-usage}
   ...
   + Gestion des utilisateurs et utilisatrices et des produits (héritée) {#user-product-management} {#user-product-management}
      ...
      + Migration des utilisateurs vers Adobe Admin Console {#migrate-users} {#migrate-users}
