...
**[!UICONTROL Gestion]** utilisateur &gt; **[!UICONTROL Groupes]** &gt; Accès aux **** rapports &gt; Outils **** de Report Suites &gt; Personnaliser ****
...
| Data Warehouse | Permet à un utilisateur non administrateur d’effectuer des appels à l’aide des méthodes de l’entrepôt de données via l’API des services Web. See [Data Warehouse - Developer Documentation](/help/export/data-warehouse/data-warehouse.md) |
...
| Classifications | Combine les autorisations suivantes : "Classifications de trafic", "Classifications vidéo", "Classifications des conversions", "Hiérarchies de classifications", "Gestionnaire de classifications" et "Importateur/exportateur de classifications et créateur de règles".  Remarque : Grâce à cette autorisation, les utilisateurs peuvent modifier les classifications pour toutes les suites de rapports, pas seulement celles sélectionnées. |
...
| Les paramètres des éléments de tableau de bord permettent d’accéder aux [petits rapports](https://marketing.adobe.com/resources/help/en_US/sc/user/dashboard.html) dans les rapports et analyses :, Mes rapports recommandés, Petit rapport Résumé pour la société, Image, Petit rapport IPC/Jauge, Totaux des suites de rapports, Texte, Petit rapport récapitulatif de l’utilisation et Ressources Web. |  |
| **Autre** |  |
