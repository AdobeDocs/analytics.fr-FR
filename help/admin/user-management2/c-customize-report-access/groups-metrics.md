...
Outre les [événements personnalisés](https://experienceleague.adobe.com/docs/analytics/implementation/vars/page-vars/events/event-serialization.html), cette catégorie comprend des événements de solution Analytics, y compris Experience Manager (AEM), Advertising Cloud (AMO), Mobile, Vidéo et Social. Pour chaque groupe personnalisé qui comprend des mesures, tous les événements de solution Analytics sont ajoutés comme de nouvelles mesures.
