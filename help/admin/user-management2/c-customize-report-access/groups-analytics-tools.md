...
seo-title: Personnalisation des autorisations des outils Analytics
solution: Analytics
subtopic: Utilisateurs et groupes
title: Personnalisation des autorisations des outils Analytics
...
# Personnalisation des autorisations des outils Analytics
...
**[!UICONTROL Gestion utilisateur]** &gt; **[!UICONTROL Groupes]** &gt; **[!UICONTROL Accès aux rapports]** &gt; **[!UICONTROL Outils Analytics]** &gt; **[!UICONTROL Personnaliser]**

>[!NOTE]
>
>La gestion des groupes a été modifiée dans la version de l'automne 2016 (20 octobre). See [Administrative Changes - Fall 2016](../../../admin/user-management2/c-user-management/permissions-changes.md#concept_86581595B86B47D5B8F90282FC3E31EF) for a summary of changes.
...
|--- |--- |
| **Généralités** |  |
| [Facturation](../../../admin/admin/billing-admin.md) | Permet d’autoriser l’accès aux informations de facturation, y compris les détails sur le trafic pour chaque suite de rapports. |
...
| Annonces | Version 14 uniquement. |
...
| [ClickMap](https://marketing.adobe.com/resources/help/en_US/sc/user/clickmap.html) | Affiche ClickMap dans le menu [!UICONTROL Outils] de l’en-tête.<br>(**Remarque :** Adobe recommande d’utiliser [Activity Map](https://marketing.adobe.com/resources/help/en_US/analytics/activitymap/activitymap-enable.html).) |
...
| [Créer/traiter des projets](https://marketing.adobe.com/resources/help/en_US/analytics/analysis-workspace/curate.html) dans Analysis Workspace | Octroie aux utilisateurs l’autorisation de créer et de traiter des projets dans Analysis Workspace. |
