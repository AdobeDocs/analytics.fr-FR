...
| [Données actives](https://marketing.adobe.com/resources/help/fr_FR/reference/data_latency.html) | Permet d’autoriser l’utilisation de la fonction Données actives dans les rapports. |
| [Utilisateurs de la licence d’Ad Hoc Analysis](https://marketing.adobe.com/resources/help/fr_FR/dsc/) | Octroie l’autorisation d’accéder aux [!UICONTROL Ad Hoc Analysis]. |
...
| [Report Builder](https://marketing.adobe.com/resources/help/fr_FR/arb/setup.html) | Octroie aux membres de ce groupe un accès aux licences du [!UICONTROL Report Builder]. |
