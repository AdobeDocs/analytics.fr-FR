...
> [!NOTE] Les accès exclus par l’adresse IP sont facturés en tant qu’appels [](https://marketing.adobe.com/resources/help/en_US/reference/primary_server_calls.html)serveur.
...
> [!NOTE] L’exclusion par ordinateur fonctionne uniquement si :
>
