...
Pour plus d’informations sur le produit Adobe Analytics à utiliser, voir [Quel outil Adobe Analytics dois-je utiliser ?](/help/admin/admin/get-started/which-analytics-tool.md).
