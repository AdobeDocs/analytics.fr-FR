...
| Élément | Description |
|---|---|
| [!UICONTROL Nom] | Nom de la classification. |
| [!UICONTROL Options (Texte uniquement)] | Crée une liste de valeurs de classification disponibles pour cette classification. Utilisez [!UICONTROL Options] avec des variables de campagne afin de fournir aux utilisateurs la liste des valeurs prises en charge pour leur classification dans le [!UICONTROL Gestionnaire de campagnes]. |
