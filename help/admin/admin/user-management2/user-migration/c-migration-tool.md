 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    ...
    </ul> <p>Ces fonctionnalités resteront disponibles dans la gestion des utilisateurs d’Analytics. </p> <p>Voir <a href="/help/admin/admin/user-management2/user-migration/c-migration-tool.md"> Fonctionnalités d’Analytics non prises en charge dans Adobe Admin Console</a> pour plus d’informations. </p> </td> 
  </tr> 
  <tr> 
