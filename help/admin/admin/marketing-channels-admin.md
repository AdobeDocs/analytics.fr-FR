...
Les  marketing sont généralement utilisées pour fournir des informations sur la manière dont (par l’intermédiaire de quel ) les arrivent sur votre site. Vous pouvez créer et personnaliser des règles de traitement des canaux marketing en fonction des canaux dont vous souhaitez effectuer le suivi et de la méthode de suivi à appliquer.
