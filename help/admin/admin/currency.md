...
seo-description: Codes de devise utilisés dans Experience Cloud.
seo-title: Codes de devise
solution: Analytics
...
Codes de devise utilisés dans Experience Cloud.

| USD | États-Unis, dollars |
|---|---|
...
| SPL | Seborga, luigino |
| SRG | Suriname, livres |
| STD | São Tomé et Príncipe, dobras |
...
| VUV | Vanuatu, vatu |
| WST | Samoa, tala |
| XAF | République centrafricaine, franc CFA |
| XAG | Argent, onces |
| XAU | Or, onces |
| XCD | Caraïbes orientales, dollars |
| XDR | Fonds monétaire international, tirage spécial |
...
| TRY | Turquie, lire |
| RUB | Russie, roubles |
| RON | Roumanie, nouveaux Lei |
| AFN | Afghanistan, afghanis |
| AZN | Azerbaïdjan, nouveaux manats |
