...
Server-side forwarding requires the [Identity Service](https://marketing.adobe.com/resources/help/en_US/mcvid/). Le service d'identité fournit un ID universel qui identifie les visiteurs du site pour toutes les solutions dans Experience Cloud. Vous devez implémenter le service d’identification pour que le transfert côté serveur fonctionne.
