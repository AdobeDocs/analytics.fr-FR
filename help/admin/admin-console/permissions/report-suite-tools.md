...
Ce tableau répertorie tous les éléments d’autorisation sous Outils de suites de rapports lors de la configuration d’un profil de produit dans Adobe Admin Console. Ces éléments d’autorisation s’appliquent uniquement aux suites de rapports incluses dans ce même profil de produit. Si le profil de produit actuel ne contient aucune suite de rapports, l’inclusion de ces autorisations n’a aucun effet.
...
| [!UICONTROL Rapport Canal] | Inutilisé. |
...
| [!UICONTROL Visites retours quotidiennes] | Inutilisé. |
...
| [!UICONTROL Mes rapports recommandés] | Inutilisé. |
...
| [!UICONTROL Petit rapport de test du tableau de bord R&amp;A] | Inutilisé. |
| [!UICONTROL Petit rapport Résumé de l’utilisation du tableau de bord R&amp;A] | Inutilisé. |
