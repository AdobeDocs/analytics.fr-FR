---
description: Identifiez les identifiants capturés dans vos données Analytics et décidez lesquels vous utiliserez pour les demandes de confidentialité des données.
...
<table id="table_E25612E32A03449A8E5DA00B88FCEB9E"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Certains clients intègrent des ID dans <a href="https://docs.adobe.com/content/help/fr-FR/analytics/implementation/vars/page-vars/evar.html">des variables de trafic personnalisées (props) ou des variables de conversion personnalisées (eVars)</a>. Si le plus courant est l’ID de gestion de la relation client, d’autres comprennent des adresses électroniques, des noms d’utilisateur de connexion, des numéros de fidélité des clients ou un hachage de ces valeurs. </p> 
