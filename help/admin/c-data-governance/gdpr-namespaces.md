...
La valeur doit être spécifiée sous la forme de deux nombres hexadécimaux à 16 chiffres ou de deux nombres décimaux à 19 chiffres. Les nombres doivent être séparés par un tiret, un tiret bas ou un deux-points. Des zéros de début doivent être ajoutés si l’un ou l’autre nombre ne comporte pas suffisamment de chiffres.
