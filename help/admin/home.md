...
* Analytics Admin Console : Utilisez cette zone pour la gestion des variables et des suites de rapports. It can be accessed by clicking [!UICONTROL Admin] in the top header of Adobe Analytics.
