...
| **[!UICONTROL Espace de noms]** | Lorsque vous étiquetez une variable comme ID-DEVICE ou ID-PERSON, vous êtes invité à fournir un espace de noms. Vous pouvez utiliser un espace de noms défini précédemment ou en définir un nouveau. |
...
Consultez [Attribuer ou modifier des étiquettes de confidentialité de suites de rapports](/help/admin/tools/privacy-labeling/labeling-overview.md).
