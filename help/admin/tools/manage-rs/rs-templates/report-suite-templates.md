...
Pour gagner du temps lors de la création d’une suite de rapports, vous pouvez sélectionner un modèle similaire à la configuration de suite de rapports que vous avez conçue. La sélection d’un modèle de suite de rapports ne limite en rien votre implémentation. Toute configuration effectuée par un modèle de suite de rapports peut être modifiée une fois la suite de rapports créée.

[En savoir plus](/help/admin/tools/manage-rs/rs-templates/default-rs-template.md)
