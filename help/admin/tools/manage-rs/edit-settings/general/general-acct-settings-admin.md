...
Voir ![VideoCheckedOut](/help/assets/icons/VideoCheckedOut.svg) [Configuration des paramètres généraux du compte](https://experienceleague.adobe.com/fr/docs/analytics-learn/tutorials/administration/manage-report-suites/configuring-general-account-settings){target="_blank"} pour une vidéo de démonstration.
