...
title: Mesures et dimensions en temps réel prises en charge (administration)
feature: Real-time
...
## Mesures prises en charge  {#metrics}
...
## Dimensions prises en charge  {#dimensions}
...
* Lien de sortie
* Variables Custom Insight (props) 1 à 75 (si elles sont activées dans la suite de rapports)
