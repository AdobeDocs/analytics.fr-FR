...
source-git-commit: 37f3d5bb4fb4f8de61560b09f4a96ee54c591305
workflow-type: tm+mt
source-wordcount: '5025'
ht-degree: 97%
...
| Fonctionnalité | Description | [Le déploiement commence](releases.md) | [Disponibilité générale](releases.md) |
| ----------- | ---------- | ------- | ---- |
| **Module complémentaire Collection de médias en flux continu : envoyez des données Roku à Adobe Experience Platform Edge Network** | Maintenant que [installation du module complémentaire Collection de médias en flux continu avec Edge Experience Platform](https://experienceleague.adobe.com/fr/docs/media-analytics/using/implementation/edge-recommended/media-edge-sdk/implementation-edge), vous pouvez utiliser le SDK Adobe Experience Platform Roku pour envoyer des données multimédia en continu à Adobe Experience Platform. |  | 12 avril 2024 |
