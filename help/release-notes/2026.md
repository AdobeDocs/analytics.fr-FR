...
Découvrez les dernières mises à jour des [produits Adobe CX Enterprise](https://business.adobe.com/fr/products/adobe-experience-cloud-products.html). Accédez aux derniers cours, tutoriels et documents d’auto-assistance sur Experience League.
...
| **Rapport API avancé avec tendance par date**<br/> Nouveau guide de rapport avancé avec tendance par date de l’API Adobe Analytics 2.0. Créez des rapports d’API avancés présentant les tendances dans le temps à l’aide de comparaisons de périodes et de segments. [En savoir plus](https://developer.adobe.com/analytics-apis/docs/2.0/guides/endpoints/reports/advanced/) | | Mars 2026 |
