...
| **Amélioration du workflow de migration du SDK Web** | Les flux de données mappent désormais automatiquement les champs de l’objet de données SDK Web directement à Adobe Analytics. [Mappage d’objet de données](/help/implement/aep-edge/data-var-mapping.md) est similaire à [Mappage d’objet XDM](/help/implement/aep-edge/xdm-var-mapping.md), mais ne nécessite pas de schéma XDM. Ce workflow amélioré offre les avantages suivants :<ul><li>Cela retarde l’utilisation d’un schéma jusqu’à ce que vous soyez prêt à envoyer des données à Adobe Experience Platform. Si un schéma était requis à ce stade de la migration de mise en oeuvre, vous seriez contraint d’utiliser un schéma basé sur les champs Adobe Analytics. Les services Adobe Experience Platform, tels que Customer Journey Analytics, n’ont pas de concept de props ou d’eVars. Un schéma axé sur Analytics peut poser des problèmes si votre entreprise souhaite utiliser son propre schéma à l’avenir.</li><li>Après avoir apporté des modifications à la mise en oeuvre du SDK Web, votre entreprise est mieux placée pour migrer d’Adobe Analytics vers Customer Journey Analytics. Si vous envoyez des données à Adobe Analytics à l’aide du SDK Web, vous n’avez pas besoin d’apporter des modifications de mise en oeuvre supplémentaires pour envoyer des données à Adobe Experience Platform. Vous pouvez plutôt utiliser la prép de données pour mapper les champs d’objet de données à votre schéma XDM.</li></ul>Voir [Migration de l’extension de balise Adobe Analytics vers l’extension de balise SDK Web](/help/implement/aep-edge/web-sdk/analytics-extension-to-web-sdk.md) et [Migration d’AppMeasurement vers le SDK Web](../implement/aep-edge/web-sdk/appmeasurement-to-web-sdk.md) pour plus d’informations. |  | Avril 2024 |
...
| **Utilisez les mêmes comptes cloud pour [!UICONTROL Flux de données], [!UICONTROL Data Warehouse], et [!UICONTROL Jeux de classifications]** | Les comptes et emplacements cloud que vous créez peuvent désormais être utilisés pour exporter des données (avec [!UICONTROL Flux de données] et [!UICONTROL Data Warehouse]) et d’importer des données (avec [!UICONTROL Jeux de classifications]).<p> **Modifications lors de la configuration de comptes :** Les utilisateurs peuvent [Configuration de comptes d’importation et d’exportation dans le cloud](https://experienceleague.adobe.com/en/docs/analytics/components/locations/configure-import-accounts) et [Configuration des emplacements d’importation et d’exportation dans le cloud](https://experienceleague.adobe.com/en/docs/analytics/components/locations/configure-import-locations) qui peut être utilisé à l’un des usages suivants :<ul><li>Importer des données avec [!UICONTROL Jeux de classifications]</li><li>Exporter des données avec [!UICONTROL Flux de données]</li><li>Exporter des données avec [!UICONTROL Data Warehouse].</li></ul><p>**Modifications lors de la gestion des comptes et des emplacements à partir de la variable [!UICONTROL Emplacements] page**: les utilisateurs peuvent utiliser la variable [Emplacements](https://experienceleague.adobe.com/en/docs/analytics/components/locations/locations-manager) (sous [!UICONTROL Composants] > Locactions) pour afficher et gérer tous les comptes et emplacements qu’ils créent, quel que soit l’endroit où ils ont été créés. <p>Auparavant, la variable [!UICONTROL Emplacements] page appliquée uniquement aux comptes créés pour importer des données avec [!UICONTROL Jeux de classifications].</p>**Modifications lors de la gestion des emplacements à partir de [!UICONTROL Data Warehouse] ou [!UICONTROL Jeux de classifications]**<p>Lors de la gestion d’emplacements dans une zone d’application donnée ([!UICONTROL Data Warehouse] ou [!UICONTROL Jeux de classifications]), seuls les emplacements créés dans cette zone d’application spécifique sont disponibles. Par exemple, lors de l’affichage de la variable [!UICONTROL Data Warehouse] zone d’application, uniquement [!UICONTROL Data Warehouse] Les emplacements sont disponibles. Tous les comptes sont toujours disponibles dans chaque zone d’application, quelle que soit la zone d’application dans laquelle ils ont été créés. Auparavant, tous les comptes et emplacements étaient disponibles dans chaque zone d’application, quelle que soit la zone d’application dans laquelle ils avaient été créés. Cela reste vrai lors de l’affichage de la variable [!UICONTROL Flux de données] zone de l’application. | | 17 avril 2024 |
