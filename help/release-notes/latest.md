...
| **Extension Activity Map : actualisation de l’interface utilisateur** <br/>l’extension de recouvrement Activity Map a une apparence mise à jour, ainsi que des améliorations sous-jacentes qui prennent en charge les améliorations à venir.<p>(Lien vers la documentation à suivre.)</p> | | Août 2026<p>(Initialement prévu pour fin juillet)</p> |
...
**Analysis Workspace**:
**Classifications** :
**Flux de données et Data Warehouse** :
**Migration** :
**Exports** :
**Report Builder**:
**Reporting** :
