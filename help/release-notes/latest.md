...
| --- | --- | --- |
| **Fin de vie de [!DNL Reports & Analytics]** | jeudi 10 janvier 2024 | Efficace **17 janvier 2024**, Adobe interrompu [!DNL Reports & Analytics] et les rapports et fonctionnalités qui l’accompagnent. Rapports, visualisations et technologie sous-jacente qui optimisent [!DNL Reports & Analytics] ne respectent plus les normes technologiques de l’Adobe. La plupart des fonctionnalités de [!DNL Reports & Analytics] sont disponibles dans [Analysis Workspace](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/home.html?lang=fr). Depuis la publication d’Analysis Workspace en 2015, les fonctionnalités de [!DNL Reports & Analytics] ont migré vers Analysis Workspace, de telle sorte quʼun seuil de parité en matière de workflow a été atteint. [Cet avis](https://spark.adobe.com/page/6WnF8JK6IRDhf/) décrit le processus de fin de vie.<p>Le 17 janvier 2024, nous avons mis fin à de nombreuses fonctionnalités Reports &amp; Analytics associées, notamment, mais sans s’y limiter : Rapports planifiés, Extraction de données et Rapports à distance. Après le 17 janvier 2024, les rapports planifiés n’étaient plus envoyés. En outre, vous ne pouvez plus planifier de futurs rapports à partir du 17 janvier 2024. |
| **Abandon de la fonctionnalité [!UICONTROL Listes de publication]** | jeudi 10 janvier 2024 | Dans le cadre de la fin de vie de Reports &amp; Analytics, [!UICONTROL Listes de publication] a atteint la fin de vie le **17 janvier 2024**. Vous ne pouvez plus créer de [!UICONTROL Listes de publication] envoyer ou planifier [!UICONTROL Analysis Workspace] projets. |
