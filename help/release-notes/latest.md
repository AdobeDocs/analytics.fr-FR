...
**Dernière mise à jour** : jeudi 15 mai 2024
...
| ----------- | ---------- | ------- | ---- |
| **Nouvelle documentation pour la mise à niveau d’Adobe Analytics vers Customer Journey Analytics** | Pour les entreprises qui effectuent une mise à niveau d’Adobe Analytics vers Customer Journey Analytics, il existe plusieurs options de mise à niveau et de nombreuses considérations à garder à l’esprit en fonction de la mise en oeuvre Adobe Analytics actuelle et des objectifs à long terme d’une entreprise. De nouvelles ressources de documentation sont désormais disponibles pour vous aider à mieux comprendre :<ul><li>Les différents chemins de mise à niveau qui existent</li><li>Quels chemins de mise à niveau sont disponibles en fonction de la mise en oeuvre actuelle d’Adobe Analytics par une entreprise ?</li><li>Avantages et inconvénients de chaque chemin de mise à niveau</li><li>Conseils détaillés pour chaque chemin de mise à niveau</li><li>Considérations relatives à la gestion des données historiques</li></ul>[Prise en main de la mise à niveau vers Customer Journey Analytics](https://experienceleague.adobe.com/en/docs/analytics-platform/using/compare-aa-cja/upgrade-to-cja/cja-upgrade-getstarted) | | Disponible maintenant |
| **Définir `contextData` champs via XDM** | Les clients qui envoient des données à Adobe Analytics via Experience Edge Network peuvent [définition des valeurs de données contextuelles](https://experienceleague.adobe.com/en/docs/analytics/implementation/vars/page-vars/contextdata) directement dans XDM ou dans les parties &quot;données&quot; de la payload. |  | Disponible maintenant |
| **API de création de rapports en temps réel dans Analytics 2.0** | La nouvelle API de création de rapports en temps réel 2.0 d’Adobe Analytics améliore l’intégration des clients et fournit des résultats de création de rapports rapides. Ces résultats peuvent être utilisés par programmation pour travailler avec des rapports de base, de tendances et de ventilation. [En savoir plus](https://developer.adobe.com/analytics-apis/docs/2.0/guides/endpoints/reports/real-time/) | | vendredi 30 mai 2024 |
| **Média en flux continu : envoyez des données web à l’Edge Network Adobe Experience Platform avec le SDK Web.** | Vous pouvez désormais utiliser le SDK Web de Adobe Experience Platform pour envoyer des données web de médias en flux continu à Adobe Experience Platform Edge Network. Cette amélioration vous permet de créer des campagnes plus personnalisées et de fournir un contenu plus personnalisé, ce qui se traduit par un plus grand nombre de données de suivi sur lesquelles générer des rapports.<p>Cette modification fournit une méthode de collecte unifiée pour les implémentations web dans toutes les solutions Platform, telles que Customer Journey Analytics, la plateforme de données clients en temps réel en Adobe, Adobe Journey Optimizer et le transfert d’événements. Auparavant, la seule manière d’envoyer des données web de médias en flux continu à l’Edge Network était d’utiliser l’API Media Edge. [En savoir plus](https://experienceleague.adobe.com/fr/docs/media-analytics/using/implementation/edge-recommended/media-edge-sdk/implementation-edge) | | 31 mai 2024 |
...
| **Activity Map à utiliser moins d’appels serveur pour le SDK Web** | Actuellement, les événements de lien d’Activity Map sont comptabilisés comme leurs propres événements et engendrent des coûts supplémentaires. Cette amélioration applique certains événements de lien et les regroupe dans l’accès suivant, comme la manière dont les événements sont gérés par AppMeasurement. (Documentation à suivre) |  | 31 mai 2024 |

{style="table-layout:auto"}

## Correctifs dans Adobe Analytics

* Correction des problèmes de classifications suivants : AN-343186 ; AN-344711 ; AN-344856 ; AN-345094 ; AN-345179 ; AN-346265 ; AN-345288 ; AN-346339 ; AN-346560 ; AN-347572 ; AN-; AN-347681 ; AN-347768 ; AN-348024
* Correction des problèmes de Data Warehouse suivants : AN-346789 ; AN-347031 ; AN-347568 ;
...
AN-327749; AN-332949; AN-342881; AN-343171; AN-343708; AN-344034; AN-345559; AN-346023; AN-346230; AN-; AN-346330; AN-346469; AN-346606; AN-; AN-; AN-2; AN-; AN-; AN-2; AN-; AN-2; AN-;
