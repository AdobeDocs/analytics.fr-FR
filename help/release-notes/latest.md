...
| **Dimensions Data Warehouse uniquement** | Sur la base des commentaires des clientes et clients, nous avons décidé de procéder à une nouvelle évaluation. Nous ne publierons pas la fonctionnalité de dimensions automatiques réservées à Data Warehouse comme annoncé précédemment. | | À confirmer |
