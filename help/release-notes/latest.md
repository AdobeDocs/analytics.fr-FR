...
| ----------- | ---------- | ------- |
| Mode Prévisualisation du projet de carte de performance mobile | Prévisualisez le comportement de votre carte de performance mobile dans l’application Tableaux de bord Analytics, et ce directement à partir du créateur de cartes de performance. Le mode Prévisualisation permet aux utilisateurs d’interagir avec les filtres et les graphiques de la même manière quʼils le feraient dans lʼapplication. Ils peuvent ainsi se faire une idée de l’expérience utilisateur avant d’enregistrer et de partager la carte de performance. En mode Prévisualisation, les utilisateurs peuvent également utiliser le sélecteur d’appareils et tester le comportement de leur carte de performance sur différents appareils mobiles. [En savoir plus](https://experienceleague.adobe.com/docs/analytics/analyze/mobapp/create-scorecard.html?lang=fr#preview) | 16 février 2022 |
