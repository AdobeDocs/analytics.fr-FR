...
| **Les projets téléchargés au format PDF sont enregistrés sur votre poste de travail.** | Lors du téléchargement d’un projet as a PDF, le PDF est téléchargé dans le dossier des téléchargements de votre station de travail. <p>Auparavant, le téléchargement d’un projet en tant que PDF lançait le PDF dans un nouvel onglet du navigateur avec une URL unique.</p><p>Pour plus d’informations, voir [Télécharger des projets et des données](/help/analyze/analysis-workspace/curate-share/download-send.md)</p> |  | mardi 25 août 2025 |
