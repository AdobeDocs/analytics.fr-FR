...
| **Mise à jour de la navigation vers l’interface d’utilisation des attributs du client ou de la cliente** | L’interface d’utilisation des attributs du client ou de la cliente est désormais accessible directement depuis le sélecteur d’applications dans Adobe Experience Cloud. Sélectionnez **[!UICONTROL Attributs du client ou de la cliente]** dans le menu déroulant (au lieu d’accéder à [!UICONTROL Personnes] > [!UICONTROL Attributs du client ou la cliente]) et mettez à jour vos signets.  La mise à jour comprend quelques améliorations de l’interface d’utilisation. | 1er juillet 2025 | 31 juillet 2025 |
